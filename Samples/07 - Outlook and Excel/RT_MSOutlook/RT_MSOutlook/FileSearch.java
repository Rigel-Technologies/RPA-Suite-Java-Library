...
public interface FileSearch extends RT_MSOutlook._IMsoDispObj {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @param fileTypeRetVal Mandatory RT_MSOutlook.MsoFileType parameter.
   */

  @DISPID(5) //= 0x5. The runtime will prefer the VTID if present
  @VTID(18)
  void fileType(
    RT_MSOutlook.MsoFileType fileTypeRetVal);
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.MsoLastModified
   */

  @DISPID(6) //= 0x6. The runtime will prefer the VTID if present
  @VTID(19)
  RT_MSOutlook.MsoLastModified lastModified();
   ...
   * </p>
   * @param lastModifiedRetVal Mandatory RT_MSOutlook.MsoLastModified parameter.
   */

  @DISPID(6) //= 0x6. The runtime will prefer the VTID if present
  @VTID(20)
  void lastModified(
    RT_MSOutlook.MsoLastModified lastModifiedRetVal);
  ...
  @VTID(25)
  int execute(
    @Optional @DefaultValue("1") RT_MSOutlook.MsoSortBy sortBy,
    @Optional @DefaultValue("1") RT_MSOutlook.MsoSortOrder sortOrder,
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.FoundFiles
   */

  @DISPID(11) //= 0xb. The runtime will prefer the VTID if present
  @VTID(27)
  RT_MSOutlook.FoundFiles foundFiles();


  @VTID(27)
  @ReturnValue(defaultPropertyThrough={RT_MSOutlook.FoundFiles.class})
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.PropertyTests
   */

  @DISPID(12) //= 0xc. The runtime will prefer the VTID if present
  @VTID(28)
  RT_MSOutlook.PropertyTests propertyTests();


  @VTID(28)
  @ReturnValue(defaultPropertyThrough={RT_MSOutlook.PropertyTests.class})
  RT_MSOutlook.PropertyTest propertyTests(
    int index,
    @LCID int lcid);
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.SearchScopes
   */

  @DISPID(13) //= 0xd. The runtime will prefer the VTID if present
  @VTID(29)
  RT_MSOutlook.SearchScopes searchScopes();


  @VTID(29)
  @ReturnValue(defaultPropertyThrough={RT_MSOutlook.SearchScopes.class})
  RT_MSOutlook.SearchScope searchScopes(
    int index);
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.SearchFolders
   */

  @DISPID(14) //= 0xe. The runtime will prefer the VTID if present
  @VTID(30)
  RT_MSOutlook.SearchFolders searchFolders();


  @VTID(30)
  @ReturnValue(defaultPropertyThrough={RT_MSOutlook.SearchFolders.class})
  RT_MSOutlook.ScopeFolder searchFolders(
    int index);
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.FileTypes
   */

  @DISPID(16) //= 0x10. The runtime will prefer the VTID if present
  @VTID(31)
  RT_MSOutlook.FileTypes fileTypes();


  @VTID(31)
  @ReturnValue(defaultPropertyThrough={RT_MSOutlook.FileTypes.class})
  RT_MSOutlook.MsoFileType fileTypes(
    int index);
