...
public interface _BusinessCardView extends Com4jObject {
  // Methods:
  /**
   * <p>
  ...
  /**
   * <p>
   * Getter method for the COM property "CardSize"
   * </p>
   * @return  Returns a value of type int
   */

  @DISPID(64474) //= 0xfbda. The runtime will prefer the VTID if present
  @VTID(32)
  int cardSize();
  ...
  /**
   * <p>
   * Setter method for the COM property "CardSize"
   * </p>
   * @param cardSize Mandatory int parameter.
   */
