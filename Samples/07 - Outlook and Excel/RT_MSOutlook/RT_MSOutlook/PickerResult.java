...
public interface PickerResult extends RT_MSOutlook._IMsoDispObj {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.PickerFields
   */

  @DISPID(8) //= 0x8. The runtime will prefer the VTID if present
  @VTID(21)
  RT_MSOutlook.PickerFields fields();


  @VTID(21)
  @ReturnValue(defaultPropertyThrough={RT_MSOutlook.PickerFields.class})
  RT_MSOutlook.PickerField fields(
    int index);
   ...
   * </p>
   * @param fields Mandatory RT_MSOutlook.PickerFields parameter.
   */
