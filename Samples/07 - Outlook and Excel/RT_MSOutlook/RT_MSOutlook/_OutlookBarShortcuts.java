...
public interface _OutlookBarShortcuts extends Com4jObject {
  // Methods:
  /**
   * <p>
   ...
   * @return  Returns a value of type RT_MSOutlook.OutlookBarShortcut
   */

  @DISPID(81) //= 0x51. The runtime will prefer the VTID if present
  @VTID(12)
  RT_MSOutlook.OutlookBarShortcut item(
  ...
  @VTID(13)
  RT_MSOutlook.OutlookBarShortcut add(
