...
public interface SignatureInfo extends RT_MSOutlook._IMsoDispObj {
  // Methods:
  /**
   * <p>
  ...
  /**
   * @param sigdet Mandatory RT_MSOutlook.SignatureDetail parameter.
  ...
  java.lang.Object getSignatureDetail(
    RT_MSOutlook.SignatureDetail sigdet);


  /**
   * @param certdet Mandatory RT_MSOutlook.CertificateDetail parameter.
   * @return  Returns a value of type java.lang.Object
   */
  ...
  java.lang.Object getCertificateDetail(
    RT_MSOutlook.CertificateDetail certdet);
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.ContentVerificationResults
   */

  @DISPID(8) //= 0x8. The runtime will prefer the VTID if present
  @VTID(19)
  RT_MSOutlook.ContentVerificationResults contentVerificationResults();
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.CertificateVerificationResults
   */

  @DISPID(9) //= 0x9. The runtime will prefer the VTID if present
  @VTID(20)
  RT_MSOutlook.CertificateVerificationResults certificateVerificationResults();
