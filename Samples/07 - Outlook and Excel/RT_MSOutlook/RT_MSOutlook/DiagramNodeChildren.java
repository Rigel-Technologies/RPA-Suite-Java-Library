...
public interface DiagramNodeChildren extends RT_MSOutlook._IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
  ...
  @VTID(15)
  RT_MSOutlook.DiagramNode firstChild();
  ...
  @VTID(16)
  RT_MSOutlook.DiagramNode lastChild();
