...
public interface FileDialogFilters extends RT_MSOutlook._IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
   ...
   * @return  Returns a value of type RT_MSOutlook.FileDialogFilter
   */

  @DISPID(0) //= 0x0. The runtime will prefer the VTID if present
  @VTID(12)
  @DefaultMethod
  RT_MSOutlook.FileDialogFilter item(
    int index);
  ...
  @VTID(15)
  RT_MSOutlook.FileDialogFilter add(
