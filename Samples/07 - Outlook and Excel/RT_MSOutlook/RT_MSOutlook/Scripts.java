...
public interface Scripts extends RT_MSOutlook._IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
  ...
  @VTID(13)
  RT_MSOutlook.Script add(
    @Optional @MarshalAs(NativeType.Dispatch) com4j.Com4jObject anchor,
    @Optional @DefaultValue("2") RT_MSOutlook.MsoScriptLocation location,
    @Optional @DefaultValue("2") RT_MSOutlook.MsoScriptLanguage language,
