...
public interface ParagraphFormat2 extends RT_MSOutlook._IMsoDispObj {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.MsoParagraphAlignment
   */

  @DISPID(2) //= 0x2. The runtime will prefer the VTID if present
  @VTID(10)
  RT_MSOutlook.MsoParagraphAlignment alignment();
   ...
   * </p>
   * @param alignment Mandatory RT_MSOutlook.MsoParagraphAlignment parameter.
   */
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.MsoBaselineAlignment
   */

  @DISPID(3) //= 0x3. The runtime will prefer the VTID if present
  @VTID(12)
  RT_MSOutlook.MsoBaselineAlignment baselineAlignment();
   ...
   * </p>
   * @param baselineAlignment Mandatory RT_MSOutlook.MsoBaselineAlignment parameter.
   */
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.BulletFormat2
   */

  @DISPID(4) //= 0x4. The runtime will prefer the VTID if present
  @VTID(14)
  RT_MSOutlook.BulletFormat2 bullet();
  ...
  @VTID(15)
  RT_MSOutlook.MsoTriState farEastLineBreakLevel();
   ...
   * </p>
   * @param _break Mandatory RT_MSOutlook.MsoTriState parameter.
   */

  @DISPID(5) //= 0x5. The runtime will prefer the VTID if present
  @VTID(16)
  void farEastLineBreakLevel(
    RT_MSOutlook.MsoTriState _break);
  ...
  @VTID(19)
  RT_MSOutlook.MsoTriState hangingPunctuation();
   ...
   * </p>
   * @param hanging Mandatory RT_MSOutlook.MsoTriState parameter.
   */

  @DISPID(7) //= 0x7. The runtime will prefer the VTID if present
  @VTID(20)
  void hangingPunctuation(
    RT_MSOutlook.MsoTriState hanging);
  ...
  @VTID(25)
  RT_MSOutlook.MsoTriState lineRuleAfter();
   ...
   * </p>
   * @param lineRule Mandatory RT_MSOutlook.MsoTriState parameter.
   */

  @DISPID(10) //= 0xa. The runtime will prefer the VTID if present
  @VTID(26)
  void lineRuleAfter(
    RT_MSOutlook.MsoTriState lineRule);
  ...
  @VTID(27)
  RT_MSOutlook.MsoTriState lineRuleBefore();
  ...
  @VTID(29)
  RT_MSOutlook.MsoTriState lineRuleWithin();
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.TabStops2
   */

  @DISPID(17) //= 0x11. The runtime will prefer the VTID if present
  @VTID(39)
  RT_MSOutlook.TabStops2 tabStops();


  @VTID(39)
  @ReturnValue(defaultPropertyThrough={RT_MSOutlook.TabStops2.class})
  RT_MSOutlook.TabStop2 tabStops(
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.MsoTextDirection
   */

  @DISPID(18) //= 0x12. The runtime will prefer the VTID if present
  @VTID(40)
  RT_MSOutlook.MsoTextDirection textDirection();
   ...
   * </p>
   * @param direction Mandatory RT_MSOutlook.MsoTextDirection parameter.
   */

  @DISPID(18) //= 0x12. The runtime will prefer the VTID if present
  @VTID(41)
  void textDirection(
    RT_MSOutlook.MsoTextDirection direction);
