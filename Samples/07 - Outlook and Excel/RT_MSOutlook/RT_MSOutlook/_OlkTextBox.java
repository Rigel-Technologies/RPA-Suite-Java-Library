...
public interface _OlkTextBox extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.OlDragBehavior
   */

  @DISPID(225) //= 0xe1. The runtime will prefer the VTID if present
  @VTID(17)
  RT_MSOutlook.OlDragBehavior dragBehavior();
   ...
   * </p>
   * @param dragBehavior Mandatory RT_MSOutlook.OlDragBehavior parameter.
   */
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.OlEnterFieldBehavior
   */

  @DISPID(224) //= 0xe0. The runtime will prefer the VTID if present
  @VTID(21)
  RT_MSOutlook.OlEnterFieldBehavior enterFieldBehavior();
   ...
   * </p>
   * @param enterFieldBehavior Mandatory RT_MSOutlook.OlEnterFieldBehavior parameter.
   */
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.OlScrollBars
   */

  @DISPID(-535) //= 0xfffffde9. The runtime will prefer the VTID if present
  @VTID(44)
  RT_MSOutlook.OlScrollBars scrollbars();
   ...
   * </p>
   * @param scrollbars Mandatory RT_MSOutlook.OlScrollBars parameter.
   */
