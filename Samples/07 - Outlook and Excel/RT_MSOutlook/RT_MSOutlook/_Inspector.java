...
public interface _Inspector extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.OlEditorType
   */

  @DISPID(8464) //= 0x2110. The runtime will prefer the VTID if present
  @VTID(13)
  RT_MSOutlook.OlEditorType editorType();
  ...
  @VTID(14)
  @ReturnValue(type=NativeType.Dispatch)
  com4j.Com4jObject modifiedFormPages();
  ...
  @VTID(36)
  @ReturnValue(type=NativeType.Dispatch)
  com4j.Com4jObject newFormRegion();
  ...
  @VTID(37)
  @ReturnValue(type=NativeType.Dispatch)
  com4j.Com4jObject openFormRegion(
  ...
  @VTID(38)
  void saveFormRegion(
    @MarshalAs(NativeType.Dispatch) com4j.Com4jObject page,
