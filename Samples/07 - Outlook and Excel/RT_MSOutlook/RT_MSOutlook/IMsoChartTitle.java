...
public interface IMsoChartTitle extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.XlChartElementPosition
   */

  @DISPID(1671) //= 0x687. The runtime will prefer the VTID if present
  @VTID(38)
  RT_MSOutlook.XlChartElementPosition position();
   ...
   * </p>
   * @param pval Mandatory RT_MSOutlook.XlChartElementPosition parameter.
   */

  @DISPID(1671) //= 0x687. The runtime will prefer the VTID if present
  @VTID(39)
  void position(
    RT_MSOutlook.XlChartElementPosition pval);
