...
public interface CustomXMLValidationError extends RT_MSOutlook._IMsoDispObj {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.MsoCustomXMLValidationErrorType
   */

  @DISPID(1610809348) //= 0x60030004. The runtime will prefer the VTID if present
  @VTID(13)
  RT_MSOutlook.MsoCustomXMLValidationErrorType type();
