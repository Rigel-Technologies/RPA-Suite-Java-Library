...
public interface DocumentProperty extends Com4jObject {
   ...
   * </p>
   * @param lcid Mandatory int parameter.
   * @return  Returns a value of type RT_MSOutlook.MsoDocProperties
   */

  @VTID(13)
  RT_MSOutlook.MsoDocProperties type(
    @LCID int lcid);
   ...
   * </p>
   * @param lcid Mandatory int parameter.
   * @param ptypeRetVal Mandatory RT_MSOutlook.MsoDocProperties parameter.
   */

  @VTID(14)
  void type(
    @LCID int lcid,
    RT_MSOutlook.MsoDocProperties ptypeRetVal);
