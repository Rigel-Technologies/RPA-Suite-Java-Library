...
public interface ContactCard extends RT_MSOutlook._IMsoDispObj {
  // Methods:
  /**
   */
  ...
  /**
   * @param cardStyle Mandatory RT_MSOutlook.MsoContactCardStyle parameter.
  ...
  @VTID(10)
  void show(
    RT_MSOutlook.MsoContactCardStyle cardStyle,
    int rectangleLeft,
    int rectangleRight,
    int rectangleTop,
    int rectangleBottom,
