...
public interface Trendlines extends Com4jObject,Iterable<Com4jObject> {
   ...
   * @return  Returns a value of type RT_MSOutlook.IMsoTrendline
   */

  @VTID(8)
  RT_MSOutlook.IMsoTrendline add(
    @Optional @DefaultValue("-4132") RT_MSOutlook.XlTrendlineType type,
  ...
  @VTID(10)
  RT_MSOutlook.IMsoTrendline item(
  ...
  @VTID(14)
  @DefaultMethod
  RT_MSOutlook.IMsoTrendline _Default(
    @Optional @MarshalAs(NativeType.VARIANT) java.lang.Object index);
