...
public interface IMsoSeries extends Com4jObject {
   ...
   * </p>
   * @param rhs Mandatory RT_MSOutlook.XlAxisGroup parameter.
   */

  @VTID(10)
  void axisGroup(
    RT_MSOutlook.XlAxisGroup rhs);
  ...
  /**
   * @param direction Mandatory RT_MSOutlook.XlErrorBarDirection parameter.
   * @param include Mandatory RT_MSOutlook.XlErrorBarInclude parameter.
   * @param type Mandatory RT_MSOutlook.XlErrorBarType parameter.
  ...
  java.lang.Object errorBar(
    RT_MSOutlook.XlErrorBarDirection direction,
    RT_MSOutlook.XlErrorBarInclude include,
    RT_MSOutlook.XlErrorBarType type,
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.IMsoErrorBars
   */

  @VTID(17)
  RT_MSOutlook.IMsoErrorBars errorBars();
   ...
   * </p>
   * @param rhs Mandatory RT_MSOutlook.XlBarShape parameter.
   */

  @VTID(74)
  void barShape(
    RT_MSOutlook.XlBarShape rhs);
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.IMsoLeaderLines
   */

  @VTID(87)
  RT_MSOutlook.IMsoLeaderLines leaderLines();
  ...
  @VTID(97)
  RT_MSOutlook.XlColorIndex invertColorIndex();
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.XlParentDataLabelOptions
   */

  @VTID(101)
  RT_MSOutlook.XlParentDataLabelOptions parentDataLabelOption();
   ...
   * </p>
   * @param rhs Mandatory RT_MSOutlook.XlParentDataLabelOptions parameter.
   */

  @VTID(102)
  void parentDataLabelOption(
    RT_MSOutlook.XlParentDataLabelOptions rhs);
