...
public interface MsoDebugOptions_UTManager extends RT_MSOutlook._IMsoDispObj {
  // Methods:
  /**
   * <p>
  ...
  @VTID(9)
  @DefaultMethod
  RT_MSOutlook.MsoDebugOptions_UTs unitTests();


  @VTID(9)
  @ReturnValue(defaultPropertyThrough={RT_MSOutlook.MsoDebugOptions_UTs.class})
  RT_MSOutlook.MsoDebugOptions_UT unitTests(
    int index);
