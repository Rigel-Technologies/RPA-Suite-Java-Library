...
public interface _CustomTaskPane extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.MsoCTPDockPosition
   */

  @DISPID(7) //= 0x7. The runtime will prefer the VTID if present
  @VTID(17)
  RT_MSOutlook.MsoCTPDockPosition dockPosition();
   ...
   * </p>
   * @param prop Mandatory RT_MSOutlook.MsoCTPDockPosition parameter.
   */

  @DISPID(7) //= 0x7. The runtime will prefer the VTID if present
  @VTID(18)
  void dockPosition(
    RT_MSOutlook.MsoCTPDockPosition prop);
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.MsoCTPDockPositionRestrict
   */

  @DISPID(8) //= 0x8. The runtime will prefer the VTID if present
  @VTID(19)
  RT_MSOutlook.MsoCTPDockPositionRestrict dockPositionRestrict();
   ...
   * </p>
   * @param prop Mandatory RT_MSOutlook.MsoCTPDockPositionRestrict parameter.
   */

  @DISPID(8) //= 0x8. The runtime will prefer the VTID if present
  @VTID(20)
  void dockPositionRestrict(
    RT_MSOutlook.MsoCTPDockPositionRestrict prop);
