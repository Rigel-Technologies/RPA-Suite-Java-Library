...
public interface IMsoDataLabels extends Com4jObject,Iterable<Com4jObject> {
   ...
   * @return  Returns a value of type RT_MSOutlook.IMsoCharacters
   */

  @VTID(14)
  RT_MSOutlook.IMsoCharacters characters(
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.XlDataLabelPosition
   */

  @VTID(40)
  RT_MSOutlook.XlDataLabelPosition position();
   ...
   * </p>
   * @param rhs Mandatory RT_MSOutlook.XlDataLabelPosition parameter.
   */

  @VTID(41)
  void position(
    RT_MSOutlook.XlDataLabelPosition rhs);
  ...
  @VTID(55)
  RT_MSOutlook.IMsoDataLabel item(
  ...
  @VTID(60)
  @DefaultMethod
  RT_MSOutlook.IMsoDataLabel _Default(
    @MarshalAs(NativeType.VARIANT) java.lang.Object index);
