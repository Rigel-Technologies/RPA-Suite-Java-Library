...
public interface RecurrencePattern extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.OlDaysOfWeek
   */

  @DISPID(4097) //= 0x1001. The runtime will prefer the VTID if present
  @VTID(13)
  RT_MSOutlook.OlDaysOfWeek dayOfWeekMask();
   ...
   * </p>
   * @param dayOfWeekMask Mandatory RT_MSOutlook.OlDaysOfWeek parameter.
   */
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.Exceptions
   */

  @DISPID(4110) //= 0x100e. The runtime will prefer the VTID if present
  @VTID(19)
  RT_MSOutlook.Exceptions exceptions();
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.OlRecurrenceType
   */

  @DISPID(4103) //= 0x1007. The runtime will prefer the VTID if present
  @VTID(34)
  RT_MSOutlook.OlRecurrenceType recurrenceType();
   ...
   * </p>
   * @param recurrenceType Mandatory RT_MSOutlook.OlRecurrenceType parameter.
   */
  ...
  @VTID(40)
  RT_MSOutlook._AppointmentItem getOccurrence(
