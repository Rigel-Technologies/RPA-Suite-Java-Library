...
public interface Assistant extends RT_MSOutlook._IMsoDispObj {
  // Methods:
  /**
   * <p>
  ...
  /**
   * @param wizardID Mandatory int parameter.
   * @param act Mandatory RT_MSOutlook.MsoWizardActType parameter.
   * @param animation Optional parameter. Default value is com4j.Variant.getMissing()
   */
  ...
  void activateWizard(
    int wizardID,
    RT_MSOutlook.MsoWizardActType act,
    @Optional @MarshalAs(NativeType.VARIANT) java.lang.Object animation);
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.Balloon
   */

  @DISPID(1610809355) //= 0x6003000b. The runtime will prefer the VTID if present
  @VTID(20)
  RT_MSOutlook.Balloon newBalloon();
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.MsoBalloonErrorType
   */

  @DISPID(1610809356) //= 0x6003000c. The runtime will prefer the VTID if present
  @VTID(21)
  RT_MSOutlook.MsoBalloonErrorType balloonError();
   ...
   * @param alb Mandatory RT_MSOutlook.MsoAlertButtonType parameter.
   * @param alc Mandatory RT_MSOutlook.MsoAlertIconType parameter.
   * @param ald Mandatory RT_MSOutlook.MsoAlertDefaultType parameter.
   * @param alq Mandatory RT_MSOutlook.MsoAlertCancelType parameter.
  ...
  int doAlert(
    ...
    RT_MSOutlook.MsoAlertButtonType alb,
    RT_MSOutlook.MsoAlertIconType alc,
    RT_MSOutlook.MsoAlertDefaultType ald,
    RT_MSOutlook.MsoAlertCancelType alq,
