...
public interface IFind extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.MsoFileFindOptions
   */

  @DISPID(1610743815) //= 0x60020007. The runtime will prefer the VTID if present
  @VTID(14)
  RT_MSOutlook.MsoFileFindOptions options();
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.MsoFileFindView
   */

  @DISPID(1610743824) //= 0x60020010. The runtime will prefer the VTID if present
  @VTID(23)
  RT_MSOutlook.MsoFileFindView view();
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.MsoFileFindSortBy
   */

  @DISPID(1610743825) //= 0x60020011. The runtime will prefer the VTID if present
  @VTID(24)
  RT_MSOutlook.MsoFileFindSortBy sortBy();
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.MsoFileFindListBy
   */

  @DISPID(1610743826) //= 0x60020012. The runtime will prefer the VTID if present
  @VTID(25)
  RT_MSOutlook.MsoFileFindListBy listBy();
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.IFoundFiles
   */

  @DISPID(1610743828) //= 0x60020014. The runtime will prefer the VTID if present
  @VTID(27)
  RT_MSOutlook.IFoundFiles results();


  @VTID(27)
  @ReturnValue(defaultPropertyThrough={RT_MSOutlook.IFoundFiles.class})
   ...
   * </p>
   * @param penmOptions Mandatory RT_MSOutlook.MsoFileFindOptions parameter.
   */

  @DISPID(1610743815) //= 0x60020007. The runtime will prefer the VTID if present
  @VTID(36)
  void options(
    RT_MSOutlook.MsoFileFindOptions penmOptions);
   ...
   * </p>
   * @param penmView Mandatory RT_MSOutlook.MsoFileFindView parameter.
   */

  @DISPID(1610743824) //= 0x60020010. The runtime will prefer the VTID if present
  @VTID(45)
  void view(
    RT_MSOutlook.MsoFileFindView penmView);
   ...
   * </p>
   * @param penmSortBy Mandatory RT_MSOutlook.MsoFileFindSortBy parameter.
   */

  @DISPID(1610743825) //= 0x60020011. The runtime will prefer the VTID if present
  @VTID(46)
  void sortBy(
    RT_MSOutlook.MsoFileFindSortBy penmSortBy);
   ...
   * </p>
   * @param penmListBy Mandatory RT_MSOutlook.MsoFileFindListBy parameter.
   */

  @DISPID(1610743826) //= 0x60020012. The runtime will prefer the VTID if present
  @VTID(47)
  void listBy(
    RT_MSOutlook.MsoFileFindListBy penmListBy);
