...
public interface ColorFormat extends RT_MSOutlook._IMsoDispObj {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.MsoColorType
   */

  @DISPID(101) //= 0x65. The runtime will prefer the VTID if present
  @VTID(14)
  RT_MSOutlook.MsoColorType type();
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.MsoThemeColorIndex
   */

  @DISPID(104) //= 0x68. The runtime will prefer the VTID if present
  @VTID(17)
  RT_MSOutlook.MsoThemeColorIndex objectThemeColor();
   ...
   * </p>
   * @param objectThemeColor Mandatory RT_MSOutlook.MsoThemeColorIndex parameter.
   */
