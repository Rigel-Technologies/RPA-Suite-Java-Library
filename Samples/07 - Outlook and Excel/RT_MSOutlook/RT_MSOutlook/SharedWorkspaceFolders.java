...
public interface SharedWorkspaceFolders extends RT_MSOutlook._IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
   ...
   * @return  Returns a value of type RT_MSOutlook.SharedWorkspaceFolder
   */

  @DISPID(0) //= 0x0. The runtime will prefer the VTID if present
  @VTID(10)
  @DefaultMethod
  RT_MSOutlook.SharedWorkspaceFolder item(
    int index);
  ...
  @VTID(12)
  RT_MSOutlook.SharedWorkspaceFolder add(
