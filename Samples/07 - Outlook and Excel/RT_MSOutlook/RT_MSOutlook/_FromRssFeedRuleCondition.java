...
public interface _FromRssFeedRuleCondition extends Com4jObject {
  // Methods:
  /**
   * <p>
  ...
  java.lang.Object fromRssFeed();


  /**
   * <p>
   * Setter method for the COM property "FromRssFeed"
   * </p>
   * @param fromRssFeed Mandatory java.lang.Object parameter.
   */

  @DISPID(64295) //= 0xfb27. The runtime will prefer the VTID if present
  @VTID(15)
  void fromRssFeed(
    @MarshalAs(NativeType.VARIANT) java.lang.Object fromRssFeed);
