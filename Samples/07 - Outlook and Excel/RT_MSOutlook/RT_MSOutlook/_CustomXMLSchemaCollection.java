...
public interface _CustomXMLSchemaCollection extends RT_MSOutlook._IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
   ...
   * @return  Returns a value of type RT_MSOutlook.CustomXMLSchema
   */

  @DISPID(0) //= 0x0. The runtime will prefer the VTID if present
  @VTID(11)
  @DefaultMethod
  RT_MSOutlook.CustomXMLSchema item(
  ...
  @VTID(13)
  RT_MSOutlook.CustomXMLSchema add(
  ...
  /**
   * @param schemaCollection Mandatory RT_MSOutlook._CustomXMLSchemaCollection parameter.
   */
