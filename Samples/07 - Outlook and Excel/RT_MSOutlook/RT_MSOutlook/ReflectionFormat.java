...
public interface ReflectionFormat extends RT_MSOutlook._IMsoDispObj {
  // Methods:
  /**
   * <p>
   * Getter method for the COM property "Type"
   * </p>
   * @return  Returns a value of type RT_MSOutlook.MsoReflectionType
   */

  @DISPID(1) //= 0x1. The runtime will prefer the VTID if present
  @VTID(9)
  RT_MSOutlook.MsoReflectionType type();
   ...
   * </p>
   * @param type Mandatory RT_MSOutlook.MsoReflectionType parameter.
   */
