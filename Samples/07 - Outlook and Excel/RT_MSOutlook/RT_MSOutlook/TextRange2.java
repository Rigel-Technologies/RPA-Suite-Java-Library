...
public interface TextRange2 extends RT_MSOutlook._IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
  ...
  @VTID(15)
  RT_MSOutlook.TextRange2 paragraphs(
  ...
  @VTID(16)
  RT_MSOutlook.TextRange2 sentences(
    @Optional @DefaultValue("-1") int start,
    @Optional @DefaultValue("-1") int length);
  ...
  @VTID(18)
  RT_MSOutlook.TextRange2 characters(
    @Optional @DefaultValue("-1") int start,
    @Optional @DefaultValue("-1") int length);
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.ParagraphFormat2
   */

  @DISPID(10) //= 0xa. The runtime will prefer the VTID if present
  @VTID(21)
  RT_MSOutlook.ParagraphFormat2 paragraphFormat();
  ...
  @VTID(29)
  RT_MSOutlook.TextRange2 trimText();
  ...
  @VTID(30)
  RT_MSOutlook.TextRange2 insertAfter(
  ...
  @VTID(31)
  RT_MSOutlook.TextRange2 insertBefore(
    @Optional @DefaultValue("") java.lang.String newText);
  ...
  @VTID(32)
  RT_MSOutlook.TextRange2 insertSymbol(
    java.lang.String fontName,
    int charNumber,
    @Optional @DefaultValue("0") RT_MSOutlook.MsoTriState unicode);
  ...
  @VTID(37)
  RT_MSOutlook.TextRange2 paste();


  /**
   * @param format Mandatory RT_MSOutlook.MsoClipboardFormat parameter.
   * @return  Returns a value of type RT_MSOutlook.TextRange2
   */

  @DISPID(27) //= 0x1b. The runtime will prefer the VTID if present
  @VTID(38)
  RT_MSOutlook.TextRange2 pasteSpecial(
    RT_MSOutlook.MsoClipboardFormat format);


  /**
   * @param type Mandatory RT_MSOutlook.MsoTextChangeCase parameter.
   */

  @DISPID(28) //= 0x1c. The runtime will prefer the VTID if present
  @VTID(39)
  void changeCase(
    RT_MSOutlook.MsoTextChangeCase type);
  ...
  @VTID(42)
  RT_MSOutlook.TextRange2 find(
    java.lang.String findWhat,
    @Optional @DefaultValue("0") int after,
    @Optional @DefaultValue("0") RT_MSOutlook.MsoTriState matchCase,
    @Optional @DefaultValue("0") RT_MSOutlook.MsoTriState wholeWords);
  ...
  @VTID(43)
  RT_MSOutlook.TextRange2 replace(
    java.lang.String findWhat,
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.MsoLanguageID
   */

  @DISPID(34) //= 0x22. The runtime will prefer the VTID if present
  @VTID(45)
  RT_MSOutlook.MsoLanguageID languageID();
   ...
   * </p>
   * @param languageID Mandatory RT_MSOutlook.MsoLanguageID parameter.
   */
  ...
  @VTID(49)
  RT_MSOutlook.TextRange2 mathZones(
    @Optional @DefaultValue("-1") int start,
    @Optional @DefaultValue("-1") int length);


  /**
   * @param chartFieldType Mandatory RT_MSOutlook.MsoChartFieldType parameter.
  ...
  @VTID(50)
  RT_MSOutlook.TextRange2 insertChartField(
    RT_MSOutlook.MsoChartFieldType chartFieldType,
