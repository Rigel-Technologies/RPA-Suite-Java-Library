...
public interface IMsoTrendline extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.XlTrendlineType
   */

  @VTID(34)
  RT_MSOutlook.XlTrendlineType type();
   ...
   * </p>
   * @param rhs Mandatory RT_MSOutlook.XlTrendlineType parameter.
   */

  @VTID(35)
  void type(
    RT_MSOutlook.XlTrendlineType rhs);
