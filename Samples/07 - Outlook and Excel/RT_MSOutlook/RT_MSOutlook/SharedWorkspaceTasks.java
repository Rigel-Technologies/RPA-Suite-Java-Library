...
public interface SharedWorkspaceTasks extends RT_MSOutlook._IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
   ...
   * @return  Returns a value of type RT_MSOutlook.SharedWorkspaceTask
   */

  @DISPID(0) //= 0x0. The runtime will prefer the VTID if present
  @VTID(9)
  @DefaultMethod
  RT_MSOutlook.SharedWorkspaceTask item(
    int index);
  ...
  @VTID(11)
  RT_MSOutlook.SharedWorkspaceTask add(
