...
public interface IMsoChart extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.IMsoChartTitle
   */

  @DISPID(1610743811) //= 0x60020003. The runtime will prefer the VTID if present
  @VTID(10)
  RT_MSOutlook.IMsoChartTitle chartTitle();
   ...
   * </p>
   * @param pres Mandatory RT_MSOutlook.XlDisplayBlanksAs parameter.
   */

  @DISPID(1610743826) //= 0x60020012. The runtime will prefer the VTID if present
  @VTID(25)
  void displayBlanksAs(
    RT_MSOutlook.XlDisplayBlanksAs pres);
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.XlDisplayBlanksAs
   */

  @DISPID(1610743826) //= 0x60020012. The runtime will prefer the VTID if present
  @VTID(26)
  RT_MSOutlook.XlDisplayBlanksAs displayBlanksAs();
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.IMsoCorners
   */

  @DISPID(79) //= 0x4f. The runtime will prefer the VTID if present
  @VTID(46)
  RT_MSOutlook.IMsoCorners corners();
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.XlChartType
   */

  @DISPID(1400) //= 0x578. The runtime will prefer the VTID if present
  @VTID(48)
  RT_MSOutlook.XlChartType chartType();
   ...
   * </p>
   * @param rhs Mandatory RT_MSOutlook.XlChartType parameter.
   */

  @DISPID(1400) //= 0x578. The runtime will prefer the VTID if present
  @VTID(49)
  void chartType(
    RT_MSOutlook.XlChartType rhs);
  ...
  /**
   * @param chartType Mandatory RT_MSOutlook.XlChartType parameter.
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.XlRowCol
   */

  @DISPID(202) //= 0xca. The runtime will prefer the VTID if present
  @VTID(55)
  RT_MSOutlook.XlRowCol plotBy();
   ...
   * </p>
   * @param plotBy Mandatory RT_MSOutlook.XlRowCol parameter.
   */
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.IMsoLegend
   */

  @DISPID(84) //= 0x54. The runtime will prefer the VTID if present
  @VTID(59)
  RT_MSOutlook.IMsoLegend legend();
  ...
  com4j.Com4jObject axes(
    ...
    @Optional @DefaultValue("1") RT_MSOutlook.XlAxisGroup axisGroup);
   ...
   * @return  Returns a value of type RT_MSOutlook.IMsoWalls
   */

  @DISPID(1610743864) //= 0x60020038. The runtime will prefer the VTID if present
  @VTID(63)
  RT_MSOutlook.IMsoWalls walls(
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.IMsoFloor
   */

  @DISPID(1610743865) //= 0x60020039. The runtime will prefer the VTID if present
  @VTID(64)
  RT_MSOutlook.IMsoFloor floor();
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.IMsoPlotArea
   */

  @DISPID(1610743866) //= 0x6002003a. The runtime will prefer the VTID if present
  @VTID(65)
  RT_MSOutlook.IMsoPlotArea plotArea();
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.IMsoChartArea
   */

  @DISPID(1610743869) //= 0x6002003d. The runtime will prefer the VTID if present
  @VTID(68)
  RT_MSOutlook.IMsoChartArea chartArea();
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.IMsoDataTable
   */

  @DISPID(1610743876) //= 0x60020044. The runtime will prefer the VTID if present
  @VTID(75)
  RT_MSOutlook.IMsoDataTable dataTable();
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.XlBarShape
   */

  @DISPID(1610743880) //= 0x60020048. The runtime will prefer the VTID if present
  @VTID(79)
  RT_MSOutlook.XlBarShape barShape();
   ...
   * </p>
   * @param pShape Mandatory RT_MSOutlook.XlBarShape parameter.
   */

  @DISPID(1610743880) //= 0x60020048. The runtime will prefer the VTID if present
  @VTID(80)
  void barShape(
    RT_MSOutlook.XlBarShape pShape);
  ...
  @VTID(85)
  RT_MSOutlook.IMsoWalls sideWall();
  ...
  @VTID(86)
  RT_MSOutlook.IMsoWalls backWall();
  ...
  /**
   * @param rhs Mandatory RT_MSOutlook.MsoChartElementType parameter.
   */

  @DISPID(1610743900) //= 0x6002005c. The runtime will prefer the VTID if present
  @VTID(99)
  void setElement(
    RT_MSOutlook.MsoChartElementType rhs);
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.IMsoChartData
   */

  @DISPID(1610743901) //= 0x6002005d. The runtime will prefer the VTID if present
  @VTID(100)
  RT_MSOutlook.IMsoChartData chartData();
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.Shapes
   */

  @DISPID(1610743903) //= 0x6002005f. The runtime will prefer the VTID if present
  @VTID(102)
  RT_MSOutlook.Shapes shapes();


  @VTID(102)
  @ReturnValue(defaultPropertyThrough={RT_MSOutlook.Shapes.class})
   ...
   * </p>
   * @param lcid Mandatory int parameter.
   * @return  Returns a value of type RT_MSOutlook.IMsoChartGroup
   */

  @DISPID(17) //= 0x11. The runtime will prefer the VTID if present
  @VTID(105)
  RT_MSOutlook.IMsoChartGroup area3DGroup(
    @LCID int lcid);
  ...
  @VTID(107)
  RT_MSOutlook.IMsoChartGroup bar3DGroup(
    @LCID int lcid);
  ...
  @VTID(109)
  RT_MSOutlook.IMsoChartGroup column3DGroup(
    @LCID int lcid);
  ...
  @VTID(111)
  RT_MSOutlook.IMsoChartGroup line3DGroup(
    @LCID int lcid);
  ...
  @VTID(113)
  RT_MSOutlook.IMsoChartGroup pie3DGroup(
    @LCID int lcid);
  ...
  @VTID(117)
  RT_MSOutlook.IMsoChartGroup surfaceGroup(
    @LCID int lcid);
  ...
  @VTID(132)
  void protectChartSheetFormatting(
    boolean rhs);
   ...
   * </p>
   * @param plevel Mandatory RT_MSOutlook.XlCategoryLabelLevel parameter.
   */

  @DISPID(237) //= 0xed. The runtime will prefer the VTID if present
  @VTID(134)
  void categoryLabelLevel(
    RT_MSOutlook.XlCategoryLabelLevel plevel);
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.XlCategoryLabelLevel
   */

  @DISPID(237) //= 0xed. The runtime will prefer the VTID if present
  @VTID(135)
  RT_MSOutlook.XlCategoryLabelLevel categoryLabelLevel();
   ...
   * </p>
   * @param plevel Mandatory RT_MSOutlook.XlSeriesNameLevel parameter.
   */

  @DISPID(238) //= 0xee. The runtime will prefer the VTID if present
  @VTID(136)
  void seriesNameLevel(
    RT_MSOutlook.XlSeriesNameLevel plevel);
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.XlSeriesNameLevel
   */

  @DISPID(238) //= 0xee. The runtime will prefer the VTID if present
  @VTID(137)
  RT_MSOutlook.XlSeriesNameLevel seriesNameLevel();
  ...
  @VTID(143)
  boolean showExpandCollapseEntireFieldButtons();
  ...
  @DISPID(1610743944) //= 0x60020088. The runtime will prefer the VTID if present
  @VTID(144)
  void showExpandCollapseEntireFieldButtons(
    boolean res);
