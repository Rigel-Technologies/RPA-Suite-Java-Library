...
public interface CustomXMLValidationErrors extends RT_MSOutlook._IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
   ...
   * @return  Returns a value of type RT_MSOutlook.CustomXMLValidationError
   */

  @DISPID(0) //= 0x0. The runtime will prefer the VTID if present
  @VTID(11)
  @DefaultMethod
  RT_MSOutlook.CustomXMLValidationError item(
    int index);


  /**
   * @param node Mandatory RT_MSOutlook.CustomXMLNode parameter.
  ...
  @VTID(12)
  void add(
    RT_MSOutlook.CustomXMLNode node,
