...
public interface _OlkComboBox extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.OlComboBoxStyle
   */

  @DISPID(308) //= 0x134. The runtime will prefer the VTID if present
  @VTID(38)
  RT_MSOutlook.OlComboBoxStyle style();
   ...
   * </p>
   * @param style Mandatory RT_MSOutlook.OlComboBoxStyle parameter.
   */
