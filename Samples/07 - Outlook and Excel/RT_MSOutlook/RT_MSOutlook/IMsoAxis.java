...
public interface IMsoAxis extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.XlAxisGroup
   */

  @DISPID(1610743810) //= 0x60020002. The runtime will prefer the VTID if present
  @VTID(9)
  RT_MSOutlook.XlAxisGroup axisGroup();
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.IMsoAxisTitle
   */

  @DISPID(1610743811) //= 0x60020003. The runtime will prefer the VTID if present
  @VTID(10)
  RT_MSOutlook.IMsoAxisTitle axisTitle();
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.XlAxisCrosses
   */

  @DISPID(1610743814) //= 0x60020006. The runtime will prefer the VTID if present
  @VTID(13)
  RT_MSOutlook.XlAxisCrosses crosses();
   ...
   * </p>
   * @param pval Mandatory RT_MSOutlook.XlAxisCrosses parameter.
   */

  @DISPID(1610743814) //= 0x60020006. The runtime will prefer the VTID if present
  @VTID(14)
  void crosses(
    RT_MSOutlook.XlAxisCrosses pval);
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.GridLines
   */

  @DISPID(1610743825) //= 0x60020011. The runtime will prefer the VTID if present
  @VTID(24)
  RT_MSOutlook.GridLines majorGridlines();
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.XlTickMark
   */

  @DISPID(1610743826) //= 0x60020012. The runtime will prefer the VTID if present
  @VTID(25)
  RT_MSOutlook.XlTickMark majorTickMark();
   ...
   * </p>
   * @param pval Mandatory RT_MSOutlook.XlTickMark parameter.
   */

  @DISPID(1610743826) //= 0x60020012. The runtime will prefer the VTID if present
  @VTID(26)
  void majorTickMark(
    RT_MSOutlook.XlTickMark pval);
  ...
  @VTID(43)
  RT_MSOutlook.GridLines minorGridlines();
  ...
  @VTID(44)
  RT_MSOutlook.XlTickMark minorTickMark();
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.XlScaleType
   */

  @DISPID(1610743853) //= 0x6002002d. The runtime will prefer the VTID if present
  @VTID(52)
  RT_MSOutlook.XlScaleType scaleType();
   ...
   * </p>
   * @param pval Mandatory RT_MSOutlook.XlScaleType parameter.
   */

  @DISPID(1610743853) //= 0x6002002d. The runtime will prefer the VTID if present
  @VTID(53)
  void scaleType(
    RT_MSOutlook.XlScaleType pval);
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.XlTickLabelPosition
   */

  @DISPID(1610743856) //= 0x60020030. The runtime will prefer the VTID if present
  @VTID(55)
  RT_MSOutlook.XlTickLabelPosition tickLabelPosition();
   ...
   * </p>
   * @param pval Mandatory RT_MSOutlook.XlTickLabelPosition parameter.
   */

  @DISPID(1610743856) //= 0x60020030. The runtime will prefer the VTID if present
  @VTID(56)
  void tickLabelPosition(
    RT_MSOutlook.XlTickLabelPosition pval);
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.IMsoTickLabels
   */

  @DISPID(1610743858) //= 0x60020032. The runtime will prefer the VTID if present
  @VTID(57)
  RT_MSOutlook.IMsoTickLabels tickLabels();
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.XlAxisType
   */

  @DISPID(1610743863) //= 0x60020037. The runtime will prefer the VTID if present
  @VTID(62)
  RT_MSOutlook.XlAxisType type();
   ...
   * </p>
   * @param pval Mandatory RT_MSOutlook.XlAxisType parameter.
   */

  @DISPID(1610743863) //= 0x60020037. The runtime will prefer the VTID if present
  @VTID(63)
  void type(
    RT_MSOutlook.XlAxisType pval);
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.XlTimeUnit
   */

  @DISPID(1610743865) //= 0x60020039. The runtime will prefer the VTID if present
  @VTID(64)
  RT_MSOutlook.XlTimeUnit baseUnit();
   ...
   * </p>
   * @param pval Mandatory RT_MSOutlook.XlTimeUnit parameter.
   */

  @DISPID(1610743865) //= 0x60020039. The runtime will prefer the VTID if present
  @VTID(65)
  void baseUnit(
    RT_MSOutlook.XlTimeUnit pval);
  ...
  @VTID(68)
  RT_MSOutlook.XlTimeUnit majorUnitScale();
  ...
  @VTID(70)
  RT_MSOutlook.XlTimeUnit minorUnitScale();
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.XlCategoryType
   */

  @DISPID(1610743873) //= 0x60020041. The runtime will prefer the VTID if present
  @VTID(72)
  RT_MSOutlook.XlCategoryType categoryType();
   ...
   * </p>
   * @param pval Mandatory RT_MSOutlook.XlCategoryType parameter.
   */

  @DISPID(1610743873) //= 0x60020041. The runtime will prefer the VTID if present
  @VTID(73)
  void categoryType(
    RT_MSOutlook.XlCategoryType pval);
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.XlDisplayUnit
   */

  @DISPID(1610743879) //= 0x60020047. The runtime will prefer the VTID if present
  @VTID(78)
  RT_MSOutlook.XlDisplayUnit displayUnit();
   ...
   * </p>
   * @param pval Mandatory RT_MSOutlook.XlDisplayUnit parameter.
   */

  @DISPID(1610743879) //= 0x60020047. The runtime will prefer the VTID if present
  @VTID(79)
  void displayUnit(
    RT_MSOutlook.XlDisplayUnit pval);
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.IMsoDisplayUnitLabel
   */

  @DISPID(1610743885) //= 0x6002004d. The runtime will prefer the VTID if present
  @VTID(84)
  RT_MSOutlook.IMsoDisplayUnitLabel displayUnitLabel();
