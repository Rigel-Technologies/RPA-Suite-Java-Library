...
@IID("{000630FF-0000-0000-C000-000000000046}")
public interface _SolutionsModule extends Com4jObject {
  // Methods:
  /**
   * <p>
  ...
  /**
   * @param solution Mandatory RT_MSOutlook.MAPIFolder parameter.
   * @param scope Mandatory RT_MSOutlook.OlSolutionScope parameter.
   */

  @DISPID(64574) //= 0xfc3e. The runtime will prefer the VTID if present
  @VTID(17)
  void addSolution(
    RT_MSOutlook.MAPIFolder solution,
    RT_MSOutlook.OlSolutionScope scope);
