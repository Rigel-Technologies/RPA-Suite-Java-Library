...
public interface _CommandBarComboBox extends RT_MSOutlook.CommandBarControl {
  // Methods:
  /**
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.MsoComboStyle
   */

  @DISPID(1610940430) //= 0x6005000e. The runtime will prefer the VTID if present
  @VTID(97)
  RT_MSOutlook.MsoComboStyle style();
   ...
   * </p>
   * @param pstyle Mandatory RT_MSOutlook.MsoComboStyle parameter.
   */

  @DISPID(1610940430) //= 0x6005000e. The runtime will prefer the VTID if present
  @VTID(98)
  void style(
    RT_MSOutlook.MsoComboStyle pstyle);
