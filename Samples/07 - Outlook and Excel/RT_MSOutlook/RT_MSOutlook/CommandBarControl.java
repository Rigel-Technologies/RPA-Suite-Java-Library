...
public interface CommandBarControl extends RT_MSOutlook._IMsoOleAccDispObj {
  // Methods:
  /**
   * <p>
  ...
  @VTID(36)
  RT_MSOutlook.CommandBarControl copy(
  ...
  @VTID(52)
  RT_MSOutlook.CommandBarControl move(
    @Optional @MarshalAs(NativeType.VARIANT) java.lang.Object bar,
    @Optional @MarshalAs(NativeType.VARIANT) java.lang.Object before);
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.MsoControlOLEUsage
   */

  @DISPID(1610874904) //= 0x60040018. The runtime will prefer the VTID if present
  @VTID(54)
  RT_MSOutlook.MsoControlOLEUsage oleUsage();
   ...
   * </p>
   * @param pcou Mandatory RT_MSOutlook.MsoControlOLEUsage parameter.
   */

  @DISPID(1610874904) //= 0x60040018. The runtime will prefer the VTID if present
  @VTID(55)
  void oleUsage(
    RT_MSOutlook.MsoControlOLEUsage pcou);
  ...
  @VTID(58)
  RT_MSOutlook.CommandBar parent();
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.MsoControlType
   */

  @DISPID(1610874920) //= 0x60040028. The runtime will prefer the VTID if present
  @VTID(70)
  RT_MSOutlook.MsoControlType type();
