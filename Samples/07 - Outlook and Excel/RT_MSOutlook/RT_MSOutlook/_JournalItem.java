...
public interface _JournalItem extends Com4jObject {
  // Methods:
  /**
   * <p>
  ...
  /**
   * <p>
   * Getter method for the COM property "DocPosted"
   * </p>
   * @return  Returns a value of type boolean
   */

  @DISPID(34577) //= 0x8711. The runtime will prefer the VTID if present
  @VTID(58)
  boolean docPosted();
  ...
  /**
   * <p>
   * Setter method for the COM property "DocPosted"
   * </p>
   * @param docPosted Mandatory boolean parameter.
   */
  ...
  /**
   * <p>
   * Getter method for the COM property "DocPrinted"
   * </p>
   * @return  Returns a value of type boolean
   */

  @DISPID(34574) //= 0x870e. The runtime will prefer the VTID if present
  @VTID(60)
  boolean docPrinted();
  ...
  /**
   * <p>
   * Setter method for the COM property "DocPrinted"
   * </p>
   * @param docPrinted Mandatory boolean parameter.
   */
  ...
  /**
   * <p>
   * Getter method for the COM property "DocRouted"
   * </p>
   * @return  Returns a value of type boolean
   */

  @DISPID(34576) //= 0x8710. The runtime will prefer the VTID if present
  @VTID(62)
  boolean docRouted();
  ...
  /**
   * <p>
   * Setter method for the COM property "DocRouted"
   * </p>
   * @param docRouted Mandatory boolean parameter.
   */
  ...
  /**
   * <p>
   * Getter method for the COM property "DocSaved"
   * </p>
   * @return  Returns a value of type boolean
   */

  @DISPID(34575) //= 0x870f. The runtime will prefer the VTID if present
  @VTID(64)
  boolean docSaved();
  ...
  /**
   * <p>
   * Setter method for the COM property "DocSaved"
   * </p>
   * @param docSaved Mandatory boolean parameter.
   */
  ...
  @DISPID(34567) //= 0x8707. The runtime will prefer the VTID if present
  @VTID(66)
  int duration();
  ...
  @DISPID(34568) //= 0x8708. The runtime will prefer the VTID if present
  @VTID(68)
  java.util.Date end();
  ...
  @DISPID(34560) //= 0x8700. The runtime will prefer the VTID if present
  @VTID(70)
  ...
  @DISPID(34566) //= 0x8706. The runtime will prefer the VTID if present
  @VTID(73)
  ...
  @DISPID(63269) //= 0xf725. The runtime will prefer the VTID if present
  @VTID(78)
  void startTimer();
  ...
  @DISPID(63270) //= 0xf726. The runtime will prefer the VTID if present
  @VTID(79)
  void stopTimer();
