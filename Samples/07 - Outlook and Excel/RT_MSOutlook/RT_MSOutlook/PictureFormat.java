...
public interface PictureFormat extends RT_MSOutlook._IMsoDispObj {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.MsoPictureColorType
   */

  @DISPID(101) //= 0x65. The runtime will prefer the VTID if present
  @VTID(14)
  RT_MSOutlook.MsoPictureColorType colorType();
   ...
   * </p>
   * @param colorType Mandatory RT_MSOutlook.MsoPictureColorType parameter.
   */
  ...
  @VTID(28)
  RT_MSOutlook.MsoTriState transparentBackground();
   ...
   * </p>
   * @param transparentBackground Mandatory RT_MSOutlook.MsoTriState parameter.
   */
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.Crop
   */

  @DISPID(109) //= 0x6d. The runtime will prefer the VTID if present
  @VTID(30)
  RT_MSOutlook.Crop crop();
