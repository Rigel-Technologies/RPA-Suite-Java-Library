...
public interface Script extends RT_MSOutlook._IMsoDispObj {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.MsoScriptLanguage
   */

  @DISPID(1610809349) //= 0x60030005. The runtime will prefer the VTID if present
  @VTID(14)
  RT_MSOutlook.MsoScriptLanguage language();
   ...
   * </p>
   * @param language Mandatory RT_MSOutlook.MsoScriptLanguage parameter.
   */
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.MsoScriptLocation
   */

  @DISPID(1610809351) //= 0x60030007. The runtime will prefer the VTID if present
  @VTID(16)
  RT_MSOutlook.MsoScriptLocation location();
