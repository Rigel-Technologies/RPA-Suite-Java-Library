...
public interface PropertyTests extends RT_MSOutlook._IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
   ...
   * @return  Returns a value of type RT_MSOutlook.PropertyTest
   */

  @DISPID(0) //= 0x0. The runtime will prefer the VTID if present
  @VTID(9)
  @DefaultMethod
  RT_MSOutlook.PropertyTest item(
    int index,
    @LCID int lcid);
   ...
   * @param condition Mandatory RT_MSOutlook.MsoCondition parameter.
  ...
  void add(
    ...
    @Optional @DefaultValue("1") RT_MSOutlook.MsoConnector connector);
