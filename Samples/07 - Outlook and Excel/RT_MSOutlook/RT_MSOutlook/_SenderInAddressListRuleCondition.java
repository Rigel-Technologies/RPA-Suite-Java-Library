...
public interface _SenderInAddressListRuleCondition extends Com4jObject {
  // Methods:
  /**
   * <p>
  ...
  /**
   * <p>
   * Getter method for the COM property "AddressList"
   * </p>
   * @return  Returns a value of type RT_MSOutlook.AddressList
   */

  @DISPID(64327) //= 0xfb47. The runtime will prefer the VTID if present
  @VTID(14)
  RT_MSOutlook.AddressList addressList();


  /**
   * <p>
   * Setter method for the COM property "AddressList"
   * </p>
   * @param addressList Mandatory RT_MSOutlook.AddressList parameter.
   */
