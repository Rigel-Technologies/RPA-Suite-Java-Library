...
public interface MetaProperties extends RT_MSOutlook._IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
   ...
   * @return  Returns a value of type RT_MSOutlook.MetaProperty
   */

  @DISPID(0) //= 0x0. The runtime will prefer the VTID if present
  @VTID(9)
  @DefaultMethod
  RT_MSOutlook.MetaProperty item(
  ...
  @VTID(10)
  RT_MSOutlook.MetaProperty getItemByInternalName(
