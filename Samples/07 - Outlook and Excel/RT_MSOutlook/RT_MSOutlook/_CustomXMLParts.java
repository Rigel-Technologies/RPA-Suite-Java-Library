...
public interface _CustomXMLParts extends RT_MSOutlook._IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
  ...
  @VTID(11)
  @DefaultMethod
  RT_MSOutlook._CustomXMLPart item(
  ...
  @VTID(12)
  RT_MSOutlook._CustomXMLPart add(
  ...
  @VTID(13)
  RT_MSOutlook._CustomXMLPart selectByID(
    java.lang.String id);


  /**
   * @param namespaceURI Mandatory java.lang.String parameter.
   * @return  Returns a value of type RT_MSOutlook._CustomXMLParts
   */

  @DISPID(1610809349) //= 0x60030005. The runtime will prefer the VTID if present
  @VTID(14)
  RT_MSOutlook._CustomXMLParts selectByNamespace(
