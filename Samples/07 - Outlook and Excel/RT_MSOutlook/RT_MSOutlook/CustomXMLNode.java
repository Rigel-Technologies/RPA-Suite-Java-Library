...
public interface CustomXMLNode extends RT_MSOutlook._IMsoDispObj {
  // Methods:
  /**
   * <p>
  ...
  @VTID(10)
  RT_MSOutlook.CustomXMLNodes attributes();


  @VTID(10)
  @ReturnValue(defaultPropertyThrough={RT_MSOutlook.CustomXMLNodes.class})
  RT_MSOutlook.CustomXMLNode attributes(
    int index);
  ...
  @VTID(12)
  RT_MSOutlook.CustomXMLNodes childNodes();


  @VTID(12)
  @ReturnValue(defaultPropertyThrough={RT_MSOutlook.CustomXMLNodes.class})
  RT_MSOutlook.CustomXMLNode childNodes(
    int index);
  ...
  @VTID(13)
  RT_MSOutlook.CustomXMLNode firstChild();
  ...
  @VTID(14)
  RT_MSOutlook.CustomXMLNode lastChild();
  ...
  @VTID(16)
  RT_MSOutlook.CustomXMLNode nextSibling();
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.MsoCustomXMLNodeType
   */

  @DISPID(1610809352) //= 0x60030008. The runtime will prefer the VTID if present
  @VTID(17)
  RT_MSOutlook.MsoCustomXMLNodeType nodeType();
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook._CustomXMLPart
   */

  @DISPID(1610809356) //= 0x6003000c. The runtime will prefer the VTID if present
  @VTID(21)
  RT_MSOutlook._CustomXMLPart ownerPart();
  ...
  @VTID(22)
  RT_MSOutlook.CustomXMLNode previousSibling();
  ...
  @VTID(23)
  RT_MSOutlook.CustomXMLNode parentNode();
  ...
  /**
   * @param child Mandatory RT_MSOutlook.CustomXMLNode parameter.
   */

  @DISPID(1610809369) //= 0x60030019. The runtime will prefer the VTID if present
  @VTID(34)
  void removeChild(
    RT_MSOutlook.CustomXMLNode child);
