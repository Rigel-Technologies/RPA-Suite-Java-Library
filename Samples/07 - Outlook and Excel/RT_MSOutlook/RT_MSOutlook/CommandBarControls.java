...
public interface CommandBarControls extends RT_MSOutlook._IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
  ...
  @VTID(9)
  RT_MSOutlook.CommandBarControl add(
  ...
  @VTID(11)
  @DefaultMethod
  RT_MSOutlook.CommandBarControl item(
