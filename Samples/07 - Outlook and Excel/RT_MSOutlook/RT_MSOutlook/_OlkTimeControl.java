...
public interface _OlkTimeControl extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.OlTimeStyle
   */

  @DISPID(64469) //= 0xfbd5. The runtime will prefer the VTID if present
  @VTID(32)
  RT_MSOutlook.OlTimeStyle style();
   ...
   * </p>
   * @param timeStyle Mandatory RT_MSOutlook.OlTimeStyle parameter.
   */

  @DISPID(64469) //= 0xfbd5. The runtime will prefer the VTID if present
  @VTID(33)
  void style(
    RT_MSOutlook.OlTimeStyle timeStyle);
