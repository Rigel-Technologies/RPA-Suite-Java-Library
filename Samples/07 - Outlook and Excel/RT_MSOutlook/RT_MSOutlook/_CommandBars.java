...
public interface _CommandBars extends RT_MSOutlook._IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
  ...
  @VTID(9)
  RT_MSOutlook.CommandBarControl actionControl();
  ...
  @VTID(10)
  RT_MSOutlook.CommandBar activeMenuBar();
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.MsoMenuAnimation
   */

  @DISPID(1610809356) //= 0x6003000c. The runtime will prefer the VTID if present
  @VTID(21)
  RT_MSOutlook.MsoMenuAnimation menuAnimationStyle();
   ...
   * </p>
   * @param pma Mandatory RT_MSOutlook.MsoMenuAnimation parameter.
   */

  @DISPID(1610809356) //= 0x6003000c. The runtime will prefer the VTID if present
  @VTID(22)
  void menuAnimationStyle(
    RT_MSOutlook.MsoMenuAnimation pma);
  ...
  @VTID(30)
  RT_MSOutlook.CommandBarControls findControls(
    @Optional @MarshalAs(NativeType.VARIANT) java.lang.Object type,
    @Optional @MarshalAs(NativeType.VARIANT) java.lang.Object id,
    @Optional @MarshalAs(NativeType.VARIANT) java.lang.Object tag,
    @Optional @MarshalAs(NativeType.VARIANT) java.lang.Object visible);
