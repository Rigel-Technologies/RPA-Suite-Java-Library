...
public interface Signature extends RT_MSOutlook._IMsoDispObj {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.SignatureInfo
   */

  @DISPID(1610809357) //= 0x6003000d. The runtime will prefer the VTID if present
  @VTID(22)
  RT_MSOutlook.SignatureInfo details();
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.SignatureSetup
   */

  @DISPID(1610809360) //= 0x60030010. The runtime will prefer the VTID if present
  @VTID(25)
  RT_MSOutlook.SignatureSetup setup();
