...
public interface IMsoLegend extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.XlLegendPosition
   */

  @DISPID(133) //= 0x85. The runtime will prefer the VTID if present
  @VTID(14)
  RT_MSOutlook.XlLegendPosition position();
   ...
   * </p>
   * @param rhs Mandatory RT_MSOutlook.XlLegendPosition parameter.
   */

  @DISPID(133) //= 0x85. The runtime will prefer the VTID if present
  @VTID(15)
  void position(
    RT_MSOutlook.XlLegendPosition rhs);
