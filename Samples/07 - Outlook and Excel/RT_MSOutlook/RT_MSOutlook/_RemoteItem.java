...
public interface _RemoteItem extends Com4jObject {
  // Methods:
  /**
   * <p>
  ...
  @DISPID(36615) //= 0x8f07. The runtime will prefer the VTID if present
  @VTID(56)
  ...
  /**
   * <p>
   * Getter method for the COM property "RemoteMessageClass"
   * </p>
   * @return  Returns a value of type java.lang.String
   */

  @DISPID(36610) //= 0x8f02. The runtime will prefer the VTID if present
  @VTID(57)
  java.lang.String remoteMessageClass();


  /**
   * <p>
   * Getter method for the COM property "TransferSize"
   * </p>
   * @return  Returns a value of type int
   */

  @DISPID(36613) //= 0x8f05. The runtime will prefer the VTID if present
  @VTID(58)
  int transferSize();
  ...
  /**
   * <p>
   * Getter method for the COM property "TransferTime"
   * </p>
   * @return  Returns a value of type int
   */

  @DISPID(36612) //= 0x8f04. The runtime will prefer the VTID if present
  @VTID(59)
  int transferTime();
