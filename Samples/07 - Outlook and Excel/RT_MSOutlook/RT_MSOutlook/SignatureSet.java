...
public interface SignatureSet extends RT_MSOutlook._IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
   ...
   * @return  Returns a value of type RT_MSOutlook.Signature
   */

  @DISPID(0) //= 0x0. The runtime will prefer the VTID if present
  @VTID(11)
  @DefaultMethod
  RT_MSOutlook.Signature item(
    int iSig);
  ...
  @VTID(15)
  RT_MSOutlook.Signature addNonVisibleSignature(
  ...
  @VTID(17)
  RT_MSOutlook.Signature addSignatureLine(
    @Optional @MarshalAs(NativeType.VARIANT) java.lang.Object varSigProv);
   ...
   * </p>
   * @return  Returns a value of type RT_MSOutlook.MsoSignatureSubset
   */

  @DISPID(1610809353) //= 0x60030009. The runtime will prefer the VTID if present
  @VTID(18)
  RT_MSOutlook.MsoSignatureSubset subset();
   ...
   * </p>
   * @param psubset Mandatory RT_MSOutlook.MsoSignatureSubset parameter.
   */

  @DISPID(1610809353) //= 0x60030009. The runtime will prefer the VTID if present
  @VTID(19)
  void subset(
    RT_MSOutlook.MsoSignatureSubset psubset);
