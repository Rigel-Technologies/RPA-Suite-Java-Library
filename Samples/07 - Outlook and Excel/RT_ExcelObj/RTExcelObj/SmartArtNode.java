...
public interface SmartArtNode extends RTExcelObj._IMsoDispObj {
  // Methods:
  /**
   * <p>
   ...
   * @return  Returns a value of type RTExcelObj.SmartArtNode
   */

  @DISPID(2) //= 0x2. The runtime will prefer the VTID if present
  @VTID(10)
  RTExcelObj.SmartArtNode addNode(
    @Optional @DefaultValue("1") RTExcelObj.MsoSmartArtNodePosition position,
    @Optional @DefaultValue("1") RTExcelObj.MsoSmartArtNodeType type);
  ...
  @VTID(14)
  RTExcelObj.MsoOrgChartLayoutType orgChartLayout();
  ...
  @VTID(23)
  RTExcelObj.SmartArtNode parentNode();
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.MsoSmartArtNodeType
   */

  @DISPID(15) //= 0xf. The runtime will prefer the VTID if present
  @VTID(24)
  RTExcelObj.MsoSmartArtNodeType type();
