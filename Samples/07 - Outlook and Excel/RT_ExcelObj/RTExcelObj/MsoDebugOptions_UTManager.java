...
public interface MsoDebugOptions_UTManager extends RTExcelObj._IMsoDispObj {
  // Methods:
  /**
   * <p>
  ...
  @VTID(9)
  @DefaultMethod
  RTExcelObj.MsoDebugOptions_UTs unitTests();


  @VTID(9)
  @ReturnValue(defaultPropertyThrough={RTExcelObj.MsoDebugOptions_UTs.class})
  RTExcelObj.MsoDebugOptions_UT unitTests(
    int index);
