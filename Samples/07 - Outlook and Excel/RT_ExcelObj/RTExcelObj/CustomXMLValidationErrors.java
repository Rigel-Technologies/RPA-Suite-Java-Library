...
public interface CustomXMLValidationErrors extends RTExcelObj._IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
   ...
   * @return  Returns a value of type RTExcelObj.CustomXMLValidationError
   */

  @DISPID(0) //= 0x0. The runtime will prefer the VTID if present
  @VTID(11)
  @DefaultMethod
  RTExcelObj.CustomXMLValidationError item(
    int index);


  /**
   * @param node Mandatory RTExcelObj.CustomXMLNode parameter.
