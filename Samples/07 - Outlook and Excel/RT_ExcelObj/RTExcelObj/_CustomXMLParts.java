...
public interface _CustomXMLParts extends RTExcelObj._IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
  ...
  @VTID(11)
  @DefaultMethod
  RTExcelObj._CustomXMLPart item(
  ...
  @VTID(13)
  RTExcelObj._CustomXMLPart selectByID(
    java.lang.String id);
  ...
  @VTID(14)
  RTExcelObj._CustomXMLParts selectByNamespace(
