...
public interface _Chart extends Com4jObject {
   ...
   * </p>
   * @param lcid Mandatory int parameter.
   * @return  Returns a value of type RTExcelObj.ChartGroup
   */

  @DISPID(17) //= 0x11. The runtime will prefer the VTID if present
  @VTID(44)
  RTExcelObj.ChartGroup area3DGroup(
    @LCID int lcid);
  ...
  @VTID(51)
  RTExcelObj.ChartGroup bar3DGroup(
    @LCID int lcid);
   ...
   * </p>
   * @param lcid Mandatory int parameter.
   * @return  Returns a value of type RTExcelObj.ChartArea
   */

  @DISPID(80) //= 0x50. The runtime will prefer the VTID if present
  @VTID(54)
  RTExcelObj.ChartArea chartArea(
    @LCID int lcid);
   ...
   * </p>
   * @param lcid Mandatory int parameter.
   * @return  Returns a value of type RTExcelObj.ChartTitle
   */

  @DISPID(81) //= 0x51. The runtime will prefer the VTID if present
  @VTID(57)
  RTExcelObj.ChartTitle chartTitle(
    @LCID int lcid);
  ...
  @VTID(61)
  RTExcelObj.ChartGroup column3DGroup(
    @LCID int lcid);
  ...
  void copyPicture(
    ...
    @Optional @DefaultValue("2") RTExcelObj.XlPictureAppearance size,
    @LCID int lcid);
   ...
   * </p>
   * @param lcid Mandatory int parameter.
   * @return  Returns a value of type RTExcelObj.Corners
   */

  @DISPID(79) //= 0x4f. The runtime will prefer the VTID if present
  @VTID(64)
  RTExcelObj.Corners corners(
    @LCID int lcid);
  ...
  void createPublisher(
    ...
    @Optional @DefaultValue("1") RTExcelObj.XlPictureAppearance appearance,
    @Optional @DefaultValue("1") RTExcelObj.XlPictureAppearance size,
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.DataTable
   */

  @DISPID(1395) //= 0x573. The runtime will prefer the VTID if present
  @VTID(66)
  RTExcelObj.DataTable dataTable();
   ...
   * </p>
   * @param lcid Mandatory int parameter.
   * @return  Returns a value of type RTExcelObj.Floor
   */

  @DISPID(83) //= 0x53. The runtime will prefer the VTID if present
  @VTID(80)
  RTExcelObj.Floor floor(
    @LCID int lcid);
   ...
   * </p>
   * @param lcid Mandatory int parameter.
   * @return  Returns a value of type RTExcelObj.Legend
   */

  @DISPID(84) //= 0x54. The runtime will prefer the VTID if present
  @VTID(97)
  RTExcelObj.Legend legend(
    @LCID int lcid);
  ...
  @VTID(98)
  RTExcelObj.ChartGroup line3DGroup(
    @LCID int lcid);
  ...
  /**
   * @param where Mandatory RTExcelObj.XlChartLocation parameter.
  ...
  @VTID(102)
  RTExcelObj._Chart location(
    RTExcelObj.XlChartLocation where,
  ...
  @VTID(110)
  RTExcelObj.ChartGroup pie3DGroup(
    @LCID int lcid);
   ...
   * </p>
   * @param lcid Mandatory int parameter.
   * @return  Returns a value of type RTExcelObj.PlotArea
   */

  @DISPID(85) //= 0x55. The runtime will prefer the VTID if present
  @VTID(112)
  RTExcelObj.PlotArea plotArea(
    @LCID int lcid);
  ...
  @VTID(130)
  RTExcelObj.ChartGroup surfaceGroup(
    @LCID int lcid);
   ...
   * </p>
   * @param lcid Mandatory int parameter.
   * @return  Returns a value of type RTExcelObj.Walls
   */

  @DISPID(86) //= 0x56. The runtime will prefer the VTID if present
  @VTID(137)
  RTExcelObj.Walls walls(
    @LCID int lcid);
   ...
   * </p>
   * @param rhs Mandatory RTExcelObj.XlRowCol parameter.
   */

  @DISPID(202) //= 0xca. The runtime will prefer the VTID if present
  @VTID(144)
  void plotBy(
    RTExcelObj.XlRowCol rhs);
  ...
  /**
   * @param source Mandatory RTExcelObj.Range parameter.
   * @param plotBy Optional parameter. Default value is com4j.Variant.getMissing()
   */
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.PivotLayout
   */

  @DISPID(1814) //= 0x716. The runtime will prefer the VTID if present
  @VTID(158)
  RTExcelObj.PivotLayout pivotLayout();
  ...
  /**
   * @param element Mandatory RTExcelObj.MsoChartElementType parameter.
   */

  @DISPID(2502) //= 0x9c6. The runtime will prefer the VTID if present
  @VTID(169)
  void setElement(
    RTExcelObj.MsoChartElementType element);
   ...
   * </p>
   * @param rhs Mandatory RTExcelObj.XlCategoryLabelLevel parameter.
   */

  @DISPID(3048) //= 0xbe8. The runtime will prefer the VTID if present
  @VTID(199)
  void categoryLabelLevel(
    RTExcelObj.XlCategoryLabelLevel rhs);
   ...
   * </p>
   * @param rhs Mandatory RTExcelObj.XlSeriesNameLevel parameter.
   */

  @DISPID(3049) //= 0xbe9. The runtime will prefer the VTID if present
  @VTID(201)
  void seriesNameLevel(
    RTExcelObj.XlSeriesNameLevel rhs);
