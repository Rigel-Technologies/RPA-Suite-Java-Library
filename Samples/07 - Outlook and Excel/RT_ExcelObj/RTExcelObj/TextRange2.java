...
public interface TextRange2 extends RTExcelObj._IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
  ...
  @VTID(15)
  RTExcelObj.TextRange2 paragraphs(
  ...
  @VTID(16)
  RTExcelObj.TextRange2 sentences(
    @Optional @DefaultValue("-1") int start,
    @Optional @DefaultValue("-1") int length);
  ...
  @VTID(18)
  RTExcelObj.TextRange2 characters(
    @Optional @DefaultValue("-1") int start,
    @Optional @DefaultValue("-1") int length);
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.ParagraphFormat2
   */

  @DISPID(10) //= 0xa. The runtime will prefer the VTID if present
  @VTID(21)
  RTExcelObj.ParagraphFormat2 paragraphFormat();
  ...
  @VTID(29)
  RTExcelObj.TextRange2 trimText();
  ...
  @VTID(30)
  RTExcelObj.TextRange2 insertAfter(
  ...
  @VTID(31)
  RTExcelObj.TextRange2 insertBefore(
    @Optional @DefaultValue("") java.lang.String newText);
  ...
  @VTID(32)
  RTExcelObj.TextRange2 insertSymbol(
    java.lang.String fontName,
    int charNumber,
    @Optional @DefaultValue("0") RTExcelObj.MsoTriState unicode);
  ...
  @VTID(37)
  RTExcelObj.TextRange2 paste();


  /**
   * @param format Mandatory RTExcelObj.MsoClipboardFormat parameter.
   * @return  Returns a value of type RTExcelObj.TextRange2
   */

  @DISPID(27) //= 0x1b. The runtime will prefer the VTID if present
  @VTID(38)
  RTExcelObj.TextRange2 pasteSpecial(
    RTExcelObj.MsoClipboardFormat format);


  /**
   * @param type Mandatory RTExcelObj.MsoTextChangeCase parameter.
   */

  @DISPID(28) //= 0x1c. The runtime will prefer the VTID if present
  @VTID(39)
  void changeCase(
    RTExcelObj.MsoTextChangeCase type);
  ...
  @VTID(42)
  RTExcelObj.TextRange2 find(
    java.lang.String findWhat,
    @Optional @DefaultValue("0") int after,
    @Optional @DefaultValue("0") RTExcelObj.MsoTriState matchCase,
    @Optional @DefaultValue("0") RTExcelObj.MsoTriState wholeWords);
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.MsoLanguageID
   */

  @DISPID(34) //= 0x22. The runtime will prefer the VTID if present
  @VTID(45)
  RTExcelObj.MsoLanguageID languageID();
   ...
   * </p>
   * @param languageID Mandatory RTExcelObj.MsoLanguageID parameter.
   */
  ...
  @VTID(49)
  RTExcelObj.TextRange2 mathZones(
    @Optional @DefaultValue("-1") int start,
    @Optional @DefaultValue("-1") int length);


  /**
   * @param chartFieldType Mandatory RTExcelObj.MsoChartFieldType parameter.
  ...
  @VTID(50)
  RTExcelObj.TextRange2 insertChartField(
    RTExcelObj.MsoChartFieldType chartFieldType,
