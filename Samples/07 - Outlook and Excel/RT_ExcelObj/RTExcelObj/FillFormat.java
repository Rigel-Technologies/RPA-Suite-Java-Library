...
public interface FillFormat extends RTExcelObj._IMsoDispObj {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.GradientStops
   */

  @DISPID(114) //= 0x72. The runtime will prefer the VTID if present
  @VTID(37)
  RTExcelObj.GradientStops gradientStops();


  @VTID(37)
  @ReturnValue(defaultPropertyThrough={RTExcelObj.GradientStops.class})
  RTExcelObj.GradientStop gradientStops(
    int index);
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.MsoTextureAlignment
   */

  @DISPID(117) //= 0x75. The runtime will prefer the VTID if present
  @VTID(42)
  RTExcelObj.MsoTextureAlignment textureAlignment();
   ...
   * </p>
   * @param textureAlignment Mandatory RTExcelObj.MsoTextureAlignment parameter.
   */
  ...
  @VTID(48)
  RTExcelObj.MsoTriState textureTile();
   ...
   * </p>
   * @param textureTile Mandatory RTExcelObj.MsoTriState parameter.
   */
  ...
  @VTID(50)
  RTExcelObj.MsoTriState rotateWithObject();
   ...
   * </p>
   * @param rotateWithObject Mandatory RTExcelObj.MsoTriState parameter.
   */
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.PictureEffects
   */

  @DISPID(122) //= 0x7a. The runtime will prefer the VTID if present
  @VTID(52)
  RTExcelObj.PictureEffects pictureEffects();


  @VTID(52)
  @ReturnValue(defaultPropertyThrough={RTExcelObj.PictureEffects.class})
  RTExcelObj.PictureEffect pictureEffects(
    int index);
