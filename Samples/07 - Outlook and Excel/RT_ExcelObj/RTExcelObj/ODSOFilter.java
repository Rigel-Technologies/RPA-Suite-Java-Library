...
public interface ODSOFilter extends RTExcelObj._IMsoDispObj {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.MsoFilterComparison
   */

  @DISPID(4) //= 0x4. The runtime will prefer the VTID if present
  @VTID(13)
  RTExcelObj.MsoFilterComparison comparison();
   ...
   * </p>
   * @param pComparison Mandatory RTExcelObj.MsoFilterComparison parameter.
   */

  @DISPID(4) //= 0x4. The runtime will prefer the VTID if present
  @VTID(14)
  void comparison(
    RTExcelObj.MsoFilterComparison pComparison);
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.MsoFilterConjunction
   */

  @DISPID(6) //= 0x6. The runtime will prefer the VTID if present
  @VTID(17)
  RTExcelObj.MsoFilterConjunction conjunction();
   ...
   * </p>
   * @param pConjunction Mandatory RTExcelObj.MsoFilterConjunction parameter.
   */

  @DISPID(6) //= 0x6. The runtime will prefer the VTID if present
  @VTID(18)
  void conjunction(
    RTExcelObj.MsoFilterConjunction pConjunction);
