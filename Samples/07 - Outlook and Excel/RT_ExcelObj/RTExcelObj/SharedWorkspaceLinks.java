...
public interface SharedWorkspaceLinks extends RTExcelObj._IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
   ...
   * @return  Returns a value of type RTExcelObj.SharedWorkspaceLink
   */

  @DISPID(0) //= 0x0. The runtime will prefer the VTID if present
  @VTID(10)
  @DefaultMethod
  RTExcelObj.SharedWorkspaceLink item(
    int index);
  ...
  @VTID(12)
  RTExcelObj.SharedWorkspaceLink add(
