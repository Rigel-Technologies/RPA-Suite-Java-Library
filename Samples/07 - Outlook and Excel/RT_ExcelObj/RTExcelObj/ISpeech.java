...
public interface ISpeech extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.XlSpeakDirection
   */

  @VTID(8)
  RTExcelObj.XlSpeakDirection direction();
   ...
   * </p>
   * @param rhs Mandatory RTExcelObj.XlSpeakDirection parameter.
   */

  @VTID(9)
  void direction(
    RTExcelObj.XlSpeakDirection rhs);
