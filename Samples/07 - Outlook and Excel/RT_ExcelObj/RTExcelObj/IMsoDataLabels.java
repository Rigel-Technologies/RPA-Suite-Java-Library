...
public interface IMsoDataLabels extends Com4jObject,Iterable<Com4jObject> {
   ...
   * @return  Returns a value of type RTExcelObj.IMsoCharacters
   */

  @VTID(14)
  RTExcelObj.IMsoCharacters characters(
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.ChartFont
   */

  @VTID(15)
  RTExcelObj.ChartFont font();
   ...
   * @return  Returns a value of type RTExcelObj.IMsoDataLabel
   */

  @VTID(55)
  RTExcelObj.IMsoDataLabel item(
  ...
  @VTID(60)
  @DefaultMethod
  RTExcelObj.IMsoDataLabel _Default(
    @MarshalAs(NativeType.VARIANT) java.lang.Object index);
