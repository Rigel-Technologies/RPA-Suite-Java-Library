...
public interface Assistant extends RTExcelObj._IMsoDispObj {
  // Methods:
  /**
   * <p>
  ...
  /**
   * @param wizardID Mandatory int parameter.
   * @param act Mandatory RTExcelObj.MsoWizardActType parameter.
   * @param animation Optional parameter. Default value is com4j.Variant.getMissing()
   */
  ...
  void activateWizard(
    int wizardID,
    RTExcelObj.MsoWizardActType act,
    @Optional @MarshalAs(NativeType.VARIANT) java.lang.Object animation);
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.Balloon
   */

  @DISPID(1610809355) //= 0x6003000b. The runtime will prefer the VTID if present
  @VTID(20)
  RTExcelObj.Balloon newBalloon();
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.MsoBalloonErrorType
   */

  @DISPID(1610809356) //= 0x6003000c. The runtime will prefer the VTID if present
  @VTID(21)
  RTExcelObj.MsoBalloonErrorType balloonError();
   ...
   * @param alb Mandatory RTExcelObj.MsoAlertButtonType parameter.
   * @param alc Mandatory RTExcelObj.MsoAlertIconType parameter.
   * @param ald Mandatory RTExcelObj.MsoAlertDefaultType parameter.
   * @param alq Mandatory RTExcelObj.MsoAlertCancelType parameter.
  ...
  int doAlert(
    ...
    RTExcelObj.MsoAlertButtonType alb,
    RTExcelObj.MsoAlertIconType alc,
    RTExcelObj.MsoAlertDefaultType ald,
    RTExcelObj.MsoAlertCancelType alq,
