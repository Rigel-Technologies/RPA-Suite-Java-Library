...
public interface CustomXMLValidationError extends RTExcelObj._IMsoDispObj {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.MsoCustomXMLValidationErrorType
   */

  @DISPID(1610809348) //= 0x60030004. The runtime will prefer the VTID if present
  @VTID(13)
  RTExcelObj.MsoCustomXMLValidationErrorType type();
