...
public interface PickerDialog extends RTExcelObj._IMsoDispObj {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.PickerProperties
   */

  @DISPID(3) //= 0x3. The runtime will prefer the VTID if present
  @VTID(13)
  RTExcelObj.PickerProperties properties();


  @VTID(13)
  @ReturnValue(defaultPropertyThrough={RTExcelObj.PickerProperties.class})
  RTExcelObj.PickerProperty properties(
    int index);

  /**
   * @return  Returns a value of type RTExcelObj.PickerResults
   */

  @DISPID(4) //= 0x4. The runtime will prefer the VTID if present
  @VTID(14)
  RTExcelObj.PickerResults createPickerResults();


  @VTID(14)
  @ReturnValue(defaultPropertyThrough={RTExcelObj.PickerResults.class})
  RTExcelObj.PickerResult createPickerResults(
    int index);
  ...
  @VTID(15)
  RTExcelObj.PickerResults show(
    @Optional @DefaultValue("-1") boolean isMultiSelect,
    @Optional @DefaultValue("0") RTExcelObj.PickerResults existingResults);
  ...
  @VTID(16)
  RTExcelObj.PickerResults resolve(
