...
public interface ISlicerPivotTables extends Com4jObject,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
  ...
  @VTID(12)
  @DefaultMethod
  RTExcelObj.PivotTable _Default(
    @MarshalAs(NativeType.VARIANT) java.lang.Object index);
  ...
  /**
   * @param pivotTable Mandatory java.lang.Object parameter.
   */

  @VTID(15)
  void removePivotTable(
    @MarshalAs(NativeType.VARIANT) java.lang.Object pivotTable);
