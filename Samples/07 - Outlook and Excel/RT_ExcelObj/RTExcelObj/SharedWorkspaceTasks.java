...
public interface SharedWorkspaceTasks extends RTExcelObj._IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
   ...
   * @return  Returns a value of type RTExcelObj.SharedWorkspaceTask
   */

  @DISPID(0) //= 0x0. The runtime will prefer the VTID if present
  @VTID(9)
  @DefaultMethod
  RTExcelObj.SharedWorkspaceTask item(
    int index);
  ...
  @VTID(11)
  RTExcelObj.SharedWorkspaceTask add(
