...
public interface _CommandBarComboBox extends RTExcelObj.CommandBarControl {
  // Methods:
  /**
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.MsoComboStyle
   */

  @DISPID(1610940430) //= 0x6005000e. The runtime will prefer the VTID if present
  @VTID(97)
  RTExcelObj.MsoComboStyle style();
   ...
   * </p>
   * @param pstyle Mandatory RTExcelObj.MsoComboStyle parameter.
   */

  @DISPID(1610940430) //= 0x6005000e. The runtime will prefer the VTID if present
  @VTID(98)
  void style(
    RTExcelObj.MsoComboStyle pstyle);
