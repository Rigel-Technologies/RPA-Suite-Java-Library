...
public interface _CustomTaskPane extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.MsoCTPDockPosition
   */

  @DISPID(7) //= 0x7. The runtime will prefer the VTID if present
  @VTID(17)
  RTExcelObj.MsoCTPDockPosition dockPosition();
   ...
   * </p>
   * @param prop Mandatory RTExcelObj.MsoCTPDockPosition parameter.
   */

  @DISPID(7) //= 0x7. The runtime will prefer the VTID if present
  @VTID(18)
  void dockPosition(
    RTExcelObj.MsoCTPDockPosition prop);
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.MsoCTPDockPositionRestrict
   */

  @DISPID(8) //= 0x8. The runtime will prefer the VTID if present
  @VTID(19)
  RTExcelObj.MsoCTPDockPositionRestrict dockPositionRestrict();
   ...
   * </p>
   * @param prop Mandatory RTExcelObj.MsoCTPDockPositionRestrict parameter.
   */

  @DISPID(8) //= 0x8. The runtime will prefer the VTID if present
  @VTID(20)
  void dockPositionRestrict(
    RTExcelObj.MsoCTPDockPositionRestrict prop);
