...
public interface FileDialogFilters extends RTExcelObj._IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
   ...
   * @return  Returns a value of type RTExcelObj.FileDialogFilter
   */

  @DISPID(0) //= 0x0. The runtime will prefer the VTID if present
  @VTID(12)
  @DefaultMethod
  RTExcelObj.FileDialogFilter item(
    int index);
  ...
  @VTID(15)
  RTExcelObj.FileDialogFilter add(
