...
public interface _VBProject_Old extends RTExcelObj._ProjectTemplate {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.vbext_VBAMode
   */

  @DISPID(119) //= 0x77. The runtime will prefer the VTID if present
  @VTID(15)
  RTExcelObj.vbext_VBAMode mode();
  ...
  @VTID(16)
  RTExcelObj._References references();
  ...
  @VTID(20)
  RTExcelObj._VBProjects collection();
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.vbext_ProjectProtection
   */

  @DISPID(131) //= 0x83. The runtime will prefer the VTID if present
  @VTID(21)
  RTExcelObj.vbext_ProjectProtection protection();
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj._VBComponents
   */

  @DISPID(135) //= 0x87. The runtime will prefer the VTID if present
  @VTID(23)
  RTExcelObj._VBComponents vbComponents();
