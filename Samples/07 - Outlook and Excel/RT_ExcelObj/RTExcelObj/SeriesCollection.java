...
public interface SeriesCollection extends Com4jObject,Iterable<Com4jObject> {
   ...
   * @return  Returns a value of type RTExcelObj.IMsoSeries
   */

  @VTID(8)
  RTExcelObj.IMsoSeries add(
    @MarshalAs(NativeType.VARIANT) java.lang.Object source,
    @Optional @DefaultValue("2") RTExcelObj.XlRowCol rowcol,
  ...
  @VTID(14)
  RTExcelObj.IMsoSeries newSeries();
  ...
  @VTID(17)
  @DefaultMethod
  RTExcelObj.IMsoSeries _Default(
    @MarshalAs(NativeType.VARIANT) java.lang.Object index);
