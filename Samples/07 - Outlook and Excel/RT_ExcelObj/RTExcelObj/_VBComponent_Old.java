...
public interface _VBComponent_Old extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj._CodeModule
   */

  @DISPID(50) //= 0x32. The runtime will prefer the VTID if present
  @VTID(11)
  RTExcelObj._CodeModule codeModule();
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.vbext_ComponentType
   */

  @DISPID(51) //= 0x33. The runtime will prefer the VTID if present
  @VTID(12)
  RTExcelObj.vbext_ComponentType type();
  ...
  @VTID(15)
  RTExcelObj._VBComponents collection();
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj._Properties
   */

  @DISPID(56) //= 0x38. The runtime will prefer the VTID if present
  @VTID(17)
  RTExcelObj._Properties properties();
  ...
  @VTID(18)
  RTExcelObj.Window designerWindow();
