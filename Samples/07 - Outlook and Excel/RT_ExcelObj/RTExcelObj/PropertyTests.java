...
public interface PropertyTests extends RTExcelObj._IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
   ...
   * @return  Returns a value of type RTExcelObj.PropertyTest
   */

  @DISPID(0) //= 0x0. The runtime will prefer the VTID if present
  @VTID(9)
  @DefaultMethod
  RTExcelObj.PropertyTest item(
    int index,
    @LCID int lcid);
   ...
   * @param condition Mandatory RTExcelObj.MsoCondition parameter.
  ...
  void add(
    ...
    @Optional @DefaultValue("1") RTExcelObj.MsoConnector connector);
