...
public interface SignatureInfo extends RTExcelObj._IMsoDispObj {
  // Methods:
  /**
   * <p>
  ...
  /**
   * @param sigdet Mandatory RTExcelObj.SignatureDetail parameter.
  ...
  java.lang.Object getSignatureDetail(
    RTExcelObj.SignatureDetail sigdet);


  /**
   * @param certdet Mandatory RTExcelObj.CertificateDetail parameter.
   * @return  Returns a value of type java.lang.Object
   */
  ...
  java.lang.Object getCertificateDetail(
    RTExcelObj.CertificateDetail certdet);
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.ContentVerificationResults
   */

  @DISPID(8) //= 0x8. The runtime will prefer the VTID if present
  @VTID(19)
  RTExcelObj.ContentVerificationResults contentVerificationResults();
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.CertificateVerificationResults
   */

  @DISPID(9) //= 0x9. The runtime will prefer the VTID if present
  @VTID(20)
  RTExcelObj.CertificateVerificationResults certificateVerificationResults();
