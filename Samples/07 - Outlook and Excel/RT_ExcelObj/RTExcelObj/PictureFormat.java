...
public interface PictureFormat extends RTExcelObj._IMsoDispObj {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @param colorType Mandatory RTExcelObj.MsoPictureColorType parameter.
   */
  ...
  @VTID(28)
  RTExcelObj.MsoTriState transparentBackground();
   ...
   * </p>
   * @param transparentBackground Mandatory RTExcelObj.MsoTriState parameter.
   */
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.Crop
   */

  @DISPID(109) //= 0x6d. The runtime will prefer the VTID if present
  @VTID(30)
  RTExcelObj.Crop crop();
