...
public interface CustomXMLNode extends RTExcelObj._IMsoDispObj {
  // Methods:
  /**
   * <p>
  ...
  @VTID(10)
  RTExcelObj.CustomXMLNodes attributes();


  @VTID(10)
  @ReturnValue(defaultPropertyThrough={RTExcelObj.CustomXMLNodes.class})
  RTExcelObj.CustomXMLNode attributes(
    int index);
  ...
  @VTID(12)
  RTExcelObj.CustomXMLNodes childNodes();


  @VTID(12)
  @ReturnValue(defaultPropertyThrough={RTExcelObj.CustomXMLNodes.class})
  RTExcelObj.CustomXMLNode childNodes(
    int index);
  ...
  @VTID(13)
  RTExcelObj.CustomXMLNode firstChild();
  ...
  @VTID(14)
  RTExcelObj.CustomXMLNode lastChild();
  ...
  @VTID(16)
  RTExcelObj.CustomXMLNode nextSibling();
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.MsoCustomXMLNodeType
   */

  @DISPID(1610809352) //= 0x60030008. The runtime will prefer the VTID if present
  @VTID(17)
  RTExcelObj.MsoCustomXMLNodeType nodeType();
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj._CustomXMLPart
   */

  @DISPID(1610809356) //= 0x6003000c. The runtime will prefer the VTID if present
  @VTID(21)
  RTExcelObj._CustomXMLPart ownerPart();
  ...
  @VTID(22)
  RTExcelObj.CustomXMLNode previousSibling();
  ...
  @VTID(23)
  RTExcelObj.CustomXMLNode parentNode();
  ...
  /**
   * @param child Mandatory RTExcelObj.CustomXMLNode parameter.
   */

  @DISPID(1610809369) //= 0x60030019. The runtime will prefer the VTID if present
  @VTID(34)
  void removeChild(
    RTExcelObj.CustomXMLNode child);
