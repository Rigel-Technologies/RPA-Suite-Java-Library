...
public interface DiagramNodeChildren extends RTExcelObj._IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
  ...
  @VTID(15)
  RTExcelObj.DiagramNode firstChild();
  ...
  @VTID(16)
  RTExcelObj.DiagramNode lastChild();
