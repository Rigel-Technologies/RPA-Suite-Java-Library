...
public interface Script extends RTExcelObj._IMsoDispObj {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.MsoScriptLanguage
   */

  @DISPID(1610809349) //= 0x60030005. The runtime will prefer the VTID if present
  @VTID(14)
  RTExcelObj.MsoScriptLanguage language();
   ...
   * </p>
   * @param language Mandatory RTExcelObj.MsoScriptLanguage parameter.
   */
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.MsoScriptLocation
   */

  @DISPID(1610809351) //= 0x60030007. The runtime will prefer the VTID if present
  @VTID(16)
  RTExcelObj.MsoScriptLocation location();
