...
public interface Scripts extends RTExcelObj._IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
  ...
  @VTID(13)
  RTExcelObj.Script add(
    @Optional @MarshalAs(NativeType.Dispatch) com4j.Com4jObject anchor,
    @Optional @DefaultValue("2") RTExcelObj.MsoScriptLocation location,
    @Optional @DefaultValue("2") RTExcelObj.MsoScriptLanguage language,
