...
public interface FileDialog extends RTExcelObj._IMsoDispObj {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.FileDialogFilters
   */

  @DISPID(1610809345) //= 0x60030001. The runtime will prefer the VTID if present
  @VTID(10)
  RTExcelObj.FileDialogFilters filters();


  @VTID(10)
  @ReturnValue(defaultPropertyThrough={RTExcelObj.FileDialogFilters.class})
  RTExcelObj.FileDialogFilter filters(
    int index);
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.MsoFileDialogView
   */

  @DISPID(1610809354) //= 0x6003000a. The runtime will prefer the VTID if present
  @VTID(19)
  RTExcelObj.MsoFileDialogView initialView();
   ...
   * </p>
   * @param pinitialview Mandatory RTExcelObj.MsoFileDialogView parameter.
   */

  @DISPID(1610809354) //= 0x6003000a. The runtime will prefer the VTID if present
  @VTID(20)
  void initialView(
    RTExcelObj.MsoFileDialogView pinitialview);
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.FileDialogSelectedItems
   */

  @DISPID(1610809358) //= 0x6003000e. The runtime will prefer the VTID if present
  @VTID(23)
  RTExcelObj.FileDialogSelectedItems selectedItems();


  @VTID(23)
  @ReturnValue(defaultPropertyThrough={RTExcelObj.FileDialogSelectedItems.class})
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.MsoFileDialogType
   */

  @DISPID(1610809359) //= 0x6003000f. The runtime will prefer the VTID if present
  @VTID(24)
  RTExcelObj.MsoFileDialogType dialogType();
