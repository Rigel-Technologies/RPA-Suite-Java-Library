...
public interface IMsoChart extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.IMsoChartTitle
   */

  @DISPID(1610743811) //= 0x60020003. The runtime will prefer the VTID if present
  @VTID(10)
  RTExcelObj.IMsoChartTitle chartTitle();
   ...
   * </p>
   * @param pres Mandatory RTExcelObj.XlDisplayBlanksAs parameter.
   */

  @DISPID(1610743826) //= 0x60020012. The runtime will prefer the VTID if present
  @VTID(25)
  void displayBlanksAs(
    RTExcelObj.XlDisplayBlanksAs pres);
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.IMsoCorners
   */

  @DISPID(79) //= 0x4f. The runtime will prefer the VTID if present
  @VTID(46)
  RTExcelObj.IMsoCorners corners();
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.XlRowCol
   */

  @DISPID(202) //= 0xca. The runtime will prefer the VTID if present
  @VTID(55)
  RTExcelObj.XlRowCol plotBy();
   ...
   * </p>
   * @param plotBy Mandatory RTExcelObj.XlRowCol parameter.
   */
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.IMsoLegend
   */

  @DISPID(84) //= 0x54. The runtime will prefer the VTID if present
  @VTID(59)
  RTExcelObj.IMsoLegend legend();
   ...
   * @return  Returns a value of type RTExcelObj.IMsoWalls
   */

  @DISPID(1610743864) //= 0x60020038. The runtime will prefer the VTID if present
  @VTID(63)
  RTExcelObj.IMsoWalls walls(
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.IMsoFloor
   */

  @DISPID(1610743865) //= 0x60020039. The runtime will prefer the VTID if present
  @VTID(64)
  RTExcelObj.IMsoFloor floor();
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.IMsoPlotArea
   */

  @DISPID(1610743866) //= 0x6002003a. The runtime will prefer the VTID if present
  @VTID(65)
  RTExcelObj.IMsoPlotArea plotArea();
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.IMsoChartArea
   */

  @DISPID(1610743869) //= 0x6002003d. The runtime will prefer the VTID if present
  @VTID(68)
  RTExcelObj.IMsoChartArea chartArea();
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.IMsoDataTable
   */

  @DISPID(1610743876) //= 0x60020044. The runtime will prefer the VTID if present
  @VTID(75)
  RTExcelObj.IMsoDataTable dataTable();
   ...
   * </p>
   * @param pShape Mandatory RTExcelObj.XlBarShape parameter.
   */

  @DISPID(1610743880) //= 0x60020048. The runtime will prefer the VTID if present
  @VTID(80)
  void barShape(
    RTExcelObj.XlBarShape pShape);
  ...
  /**
   * @param rhs Mandatory RTExcelObj.MsoChartElementType parameter.
   */

  @DISPID(1610743900) //= 0x6002005c. The runtime will prefer the VTID if present
  @VTID(99)
  void setElement(
    RTExcelObj.MsoChartElementType rhs);
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.IMsoChartData
   */

  @DISPID(1610743901) //= 0x6002005d. The runtime will prefer the VTID if present
  @VTID(100)
  RTExcelObj.IMsoChartData chartData();
  ...
  @VTID(102)
  @ReturnValue(defaultPropertyThrough={RTExcelObj.Shapes.class})
  RTExcelObj.Shape shapes(
   ...
   * </p>
   * @param lcid Mandatory int parameter.
   * @return  Returns a value of type RTExcelObj.IMsoChartGroup
   */

  @DISPID(17) //= 0x11. The runtime will prefer the VTID if present
  @VTID(105)
  RTExcelObj.IMsoChartGroup area3DGroup(
    @LCID int lcid);
  ...
  @VTID(107)
  RTExcelObj.IMsoChartGroup bar3DGroup(
    @LCID int lcid);
  ...
  @VTID(109)
  RTExcelObj.IMsoChartGroup column3DGroup(
    @LCID int lcid);
  ...
  @VTID(111)
  RTExcelObj.IMsoChartGroup line3DGroup(
    @LCID int lcid);
  ...
  @VTID(113)
  RTExcelObj.IMsoChartGroup pie3DGroup(
    @LCID int lcid);
  ...
  @VTID(117)
  RTExcelObj.IMsoChartGroup surfaceGroup(
    @LCID int lcid);
   ...
   * </p>
   * @param plevel Mandatory RTExcelObj.XlCategoryLabelLevel parameter.
   */

  @DISPID(237) //= 0xed. The runtime will prefer the VTID if present
  @VTID(134)
  void categoryLabelLevel(
    RTExcelObj.XlCategoryLabelLevel plevel);
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.XlCategoryLabelLevel
   */

  @DISPID(237) //= 0xed. The runtime will prefer the VTID if present
  @VTID(135)
  RTExcelObj.XlCategoryLabelLevel categoryLabelLevel();
   ...
   * </p>
   * @param plevel Mandatory RTExcelObj.XlSeriesNameLevel parameter.
   */

  @DISPID(238) //= 0xee. The runtime will prefer the VTID if present
  @VTID(136)
  void seriesNameLevel(
    RTExcelObj.XlSeriesNameLevel plevel);
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.XlSeriesNameLevel
   */

  @DISPID(238) //= 0xee. The runtime will prefer the VTID if present
  @VTID(137)
  RTExcelObj.XlSeriesNameLevel seriesNameLevel();
