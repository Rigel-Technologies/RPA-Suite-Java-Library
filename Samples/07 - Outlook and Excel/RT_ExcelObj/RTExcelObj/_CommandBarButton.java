...
public interface _CommandBarButton extends RTExcelObj.CommandBarControl {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.MsoButtonState
   */

  @DISPID(1610940424) //= 0x60050008. The runtime will prefer the VTID if present
  @VTID(91)
  RTExcelObj.MsoButtonState state();
   ...
   * </p>
   * @param pstate Mandatory RTExcelObj.MsoButtonState parameter.
   */

  @DISPID(1610940424) //= 0x60050008. The runtime will prefer the VTID if present
  @VTID(92)
  void state(
    RTExcelObj.MsoButtonState pstate);
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.MsoButtonStyle
   */

  @DISPID(1610940426) //= 0x6005000a. The runtime will prefer the VTID if present
  @VTID(93)
  RTExcelObj.MsoButtonStyle style();
   ...
   * </p>
   * @param pstyle Mandatory RTExcelObj.MsoButtonStyle parameter.
   */

  @DISPID(1610940426) //= 0x6005000a. The runtime will prefer the VTID if present
  @VTID(94)
  void style(
    RTExcelObj.MsoButtonStyle pstyle);
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.MsoCommandBarButtonHyperlinkType
   */

  @DISPID(1610940428) //= 0x6005000c. The runtime will prefer the VTID if present
  @VTID(95)
  RTExcelObj.MsoCommandBarButtonHyperlinkType hyperlinkType();
   ...
   * </p>
   * @param phlType Mandatory RTExcelObj.MsoCommandBarButtonHyperlinkType parameter.
   */

  @DISPID(1610940428) //= 0x6005000c. The runtime will prefer the VTID if present
  @VTID(96)
  void hyperlinkType(
    RTExcelObj.MsoCommandBarButtonHyperlinkType phlType);
