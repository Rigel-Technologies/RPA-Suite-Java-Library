...
public interface _CustomXMLSchemaCollection extends RTExcelObj._IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
   ...
   * @return  Returns a value of type RTExcelObj.CustomXMLSchema
   */

  @DISPID(0) //= 0x0. The runtime will prefer the VTID if present
  @VTID(11)
  @DefaultMethod
  RTExcelObj.CustomXMLSchema item(
  ...
  @VTID(13)
  RTExcelObj.CustomXMLSchema add(
  ...
  /**
   * @param schemaCollection Mandatory RTExcelObj._CustomXMLSchemaCollection parameter.
   */
