...
public interface ColorFormat extends RTExcelObj._IMsoDispObj {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.MsoColorType
   */

  @DISPID(101) //= 0x65. The runtime will prefer the VTID if present
  @VTID(14)
  RTExcelObj.MsoColorType type();
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.MsoThemeColorIndex
   */

  @DISPID(104) //= 0x68. The runtime will prefer the VTID if present
  @VTID(17)
  RTExcelObj.MsoThemeColorIndex objectThemeColor();
   ...
   * </p>
   * @param objectThemeColor Mandatory RTExcelObj.MsoThemeColorIndex parameter.
   */
