...
public interface SharedWorkspaceTask extends RTExcelObj._IMsoDispObj {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.MsoSharedWorkspaceTaskStatus
   */

  @DISPID(2) //= 0x2. The runtime will prefer the VTID if present
  @VTID(13)
  RTExcelObj.MsoSharedWorkspaceTaskStatus status();
   ...
   * </p>
   * @param status Mandatory RTExcelObj.MsoSharedWorkspaceTaskStatus parameter.
   */
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.MsoSharedWorkspaceTaskPriority
   */

  @DISPID(3) //= 0x3. The runtime will prefer the VTID if present
  @VTID(15)
  RTExcelObj.MsoSharedWorkspaceTaskPriority priority();
   ...
   * </p>
   * @param priority Mandatory RTExcelObj.MsoSharedWorkspaceTaskPriority parameter.
   */
