...
public interface ThemeColor extends RTExcelObj._IMsoDispObj {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.MsoThemeColorSchemeIndex
   */

  @DISPID(1610809347) //= 0x60030003. The runtime will prefer the VTID if present
  @VTID(12)
  RTExcelObj.MsoThemeColorSchemeIndex themeColorSchemeIndex();
