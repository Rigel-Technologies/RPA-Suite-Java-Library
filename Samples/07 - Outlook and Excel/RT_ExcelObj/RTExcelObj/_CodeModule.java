...
public interface _CodeModule extends Com4jObject {
  ...
  @VTID(7)
  RTExcelObj._VBComponent parent();
   ...
   * @param procKind Mandatory RTExcelObj.vbext_ProcKind parameter.
   * @return  Returns a value of type int
   */
  ...
  int procStartLine(
    ...
    RTExcelObj.vbext_ProcKind procKind);
   ...
   * </p>
   * @param line Mandatory int parameter.
   * @param procKind Mandatory Holder<RTExcelObj.vbext_ProcKind> parameter.
   * @return  Returns a value of type java.lang.String
   */
  ...
  java.lang.String procOfLine(
    int line,
    Holder<RTExcelObj.vbext_ProcKind> procKind);
