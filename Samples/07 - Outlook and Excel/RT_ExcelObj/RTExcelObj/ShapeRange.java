...
public interface ShapeRange extends RTExcelObj._IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
  ...
  /**
   * @param mergeCmd Mandatory RTExcelObj.MsoMergeCmd parameter.
  ...
  @VTID(101)
  void mergeShapes(
    RTExcelObj.MsoMergeCmd mergeCmd,
    @Optional @DefaultValue("0") RTExcelObj.Shape primaryShape);
