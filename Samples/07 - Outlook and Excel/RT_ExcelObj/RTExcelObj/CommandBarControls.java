...
public interface CommandBarControls extends RTExcelObj._IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
  ...
  @VTID(9)
  RTExcelObj.CommandBarControl add(
  ...
  @VTID(11)
  @DefaultMethod
  RTExcelObj.CommandBarControl item(
