...
public interface ReflectionFormat extends RTExcelObj._IMsoDispObj {
  // Methods:
  /**
   * <p>
   * Getter method for the COM property "Type"
   * </p>
   * @return  Returns a value of type RTExcelObj.MsoReflectionType
   */

  @DISPID(1) //= 0x1. The runtime will prefer the VTID if present
  @VTID(9)
  RTExcelObj.MsoReflectionType type();
   ...
   * </p>
   * @param type Mandatory RTExcelObj.MsoReflectionType parameter.
   */
