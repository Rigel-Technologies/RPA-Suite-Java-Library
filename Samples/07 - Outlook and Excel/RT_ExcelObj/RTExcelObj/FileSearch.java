...
public interface FileSearch extends RTExcelObj._IMsoDispObj {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.MsoFileType
   */

  @DISPID(5) //= 0x5. The runtime will prefer the VTID if present
  @VTID(17)
  RTExcelObj.MsoFileType fileType();
   ...
   * </p>
   * @param fileTypeRetVal Mandatory RTExcelObj.MsoFileType parameter.
   */

  @DISPID(5) //= 0x5. The runtime will prefer the VTID if present
  @VTID(18)
  void fileType(
    RTExcelObj.MsoFileType fileTypeRetVal);
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.MsoLastModified
   */

  @DISPID(6) //= 0x6. The runtime will prefer the VTID if present
  @VTID(19)
  RTExcelObj.MsoLastModified lastModified();
   ...
   * </p>
   * @param lastModifiedRetVal Mandatory RTExcelObj.MsoLastModified parameter.
   */

  @DISPID(6) //= 0x6. The runtime will prefer the VTID if present
  @VTID(20)
  void lastModified(
    RTExcelObj.MsoLastModified lastModifiedRetVal);
  ...
  @VTID(25)
  int execute(
    @Optional @DefaultValue("1") RTExcelObj.MsoSortBy sortBy,
    @Optional @DefaultValue("1") RTExcelObj.MsoSortOrder sortOrder,
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.FoundFiles
   */

  @DISPID(11) //= 0xb. The runtime will prefer the VTID if present
  @VTID(27)
  RTExcelObj.FoundFiles foundFiles();


  @VTID(27)
  @ReturnValue(defaultPropertyThrough={RTExcelObj.FoundFiles.class})
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.PropertyTests
   */

  @DISPID(12) //= 0xc. The runtime will prefer the VTID if present
  @VTID(28)
  RTExcelObj.PropertyTests propertyTests();


  @VTID(28)
  @ReturnValue(defaultPropertyThrough={RTExcelObj.PropertyTests.class})
  RTExcelObj.PropertyTest propertyTests(
    int index,
    @LCID int lcid);
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.SearchScopes
   */

  @DISPID(13) //= 0xd. The runtime will prefer the VTID if present
  @VTID(29)
  RTExcelObj.SearchScopes searchScopes();


  @VTID(29)
  @ReturnValue(defaultPropertyThrough={RTExcelObj.SearchScopes.class})
  RTExcelObj.SearchScope searchScopes(
    int index);
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.SearchFolders
   */

  @DISPID(14) //= 0xe. The runtime will prefer the VTID if present
  @VTID(30)
  RTExcelObj.SearchFolders searchFolders();


  @VTID(30)
  @ReturnValue(defaultPropertyThrough={RTExcelObj.SearchFolders.class})
  RTExcelObj.ScopeFolder searchFolders(
    int index);
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.FileTypes
   */

  @DISPID(16) //= 0x10. The runtime will prefer the VTID if present
  @VTID(31)
  RTExcelObj.FileTypes fileTypes();


  @VTID(31)
  @ReturnValue(defaultPropertyThrough={RTExcelObj.FileTypes.class})
  RTExcelObj.MsoFileType fileTypes(
    int index);
