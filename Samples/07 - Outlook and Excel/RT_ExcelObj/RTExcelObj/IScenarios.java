...
public interface IScenarios extends Com4jObject,Iterable<Com4jObject> {
   ...
   * @return  Returns a value of type RTExcelObj.Scenario
   */

  @VTID(10)
  RTExcelObj.Scenario add(
  ...
  java.lang.Object createSummary(
    @Optional @DefaultValue("1") RTExcelObj.XlSummaryReportType reportType,
