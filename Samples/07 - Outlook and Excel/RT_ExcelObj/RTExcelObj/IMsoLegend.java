...
public interface IMsoLegend extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.XlLegendPosition
   */

  @DISPID(133) //= 0x85. The runtime will prefer the VTID if present
  @VTID(14)
  RTExcelObj.XlLegendPosition position();
   ...
   * </p>
   * @param rhs Mandatory RTExcelObj.XlLegendPosition parameter.
   */

  @DISPID(133) //= 0x85. The runtime will prefer the VTID if present
  @VTID(15)
  void position(
    RTExcelObj.XlLegendPosition rhs);
