...
public interface SharedWorkspaceFolders extends RTExcelObj._IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
   ...
   * @return  Returns a value of type RTExcelObj.SharedWorkspaceFolder
   */

  @DISPID(0) //= 0x0. The runtime will prefer the VTID if present
  @VTID(10)
  @DefaultMethod
  RTExcelObj.SharedWorkspaceFolder item(
    int index);
  ...
  @VTID(12)
  RTExcelObj.SharedWorkspaceFolder add(
