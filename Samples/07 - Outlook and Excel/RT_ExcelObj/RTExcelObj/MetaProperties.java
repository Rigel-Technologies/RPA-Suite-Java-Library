...
public interface MetaProperties extends RTExcelObj._IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
   ...
   * @return  Returns a value of type RTExcelObj.MetaProperty
   */

  @DISPID(0) //= 0x0. The runtime will prefer the VTID if present
  @VTID(9)
  @DefaultMethod
  RTExcelObj.MetaProperty item(
  ...
  @VTID(10)
  RTExcelObj.MetaProperty getItemByInternalName(
