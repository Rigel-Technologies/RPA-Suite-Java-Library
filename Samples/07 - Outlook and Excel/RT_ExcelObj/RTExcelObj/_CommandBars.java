...
public interface _CommandBars extends RTExcelObj._IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
  ...
  @VTID(9)
  RTExcelObj.CommandBarControl actionControl();
  ...
  @VTID(10)
  RTExcelObj.CommandBar activeMenuBar();
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.MsoMenuAnimation
   */

  @DISPID(1610809356) //= 0x6003000c. The runtime will prefer the VTID if present
  @VTID(21)
  RTExcelObj.MsoMenuAnimation menuAnimationStyle();
   ...
   * </p>
   * @param pma Mandatory RTExcelObj.MsoMenuAnimation parameter.
   */

  @DISPID(1610809356) //= 0x6003000c. The runtime will prefer the VTID if present
  @VTID(22)
  void menuAnimationStyle(
    RTExcelObj.MsoMenuAnimation pma);
  ...
  @VTID(30)
  RTExcelObj.CommandBarControls findControls(
    @Optional @MarshalAs(NativeType.VARIANT) java.lang.Object type,
    @Optional @MarshalAs(NativeType.VARIANT) java.lang.Object id,
    @Optional @MarshalAs(NativeType.VARIANT) java.lang.Object tag,
    @Optional @MarshalAs(NativeType.VARIANT) java.lang.Object visible);
