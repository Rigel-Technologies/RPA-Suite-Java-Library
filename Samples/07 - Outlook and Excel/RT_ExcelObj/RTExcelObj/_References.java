...
public interface _References extends Com4jObject,Iterable<Com4jObject> {
   ...
   * @return  Returns a value of type RTExcelObj.Reference
   */

  @DISPID(0) //= 0x0. The runtime will prefer the VTID if present
  @VTID(9)
  @DefaultMethod
  RTExcelObj.Reference item(
  ...
  @VTID(12)
  RTExcelObj.Reference addFromGuid(
  ...
  @VTID(13)
  RTExcelObj.Reference addFromFile(
    java.lang.String fileName);


  /**
   * @param reference Mandatory RTExcelObj.Reference parameter.
   */

  @DISPID(1610743815) //= 0x60020007. The runtime will prefer the VTID if present
  @VTID(14)
  void remove(
    RTExcelObj.Reference reference);
