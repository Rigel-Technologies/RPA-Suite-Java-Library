...
public interface ContactCard extends RTExcelObj._IMsoDispObj {
  // Methods:
  /**
   */
  ...
  /**
   * @param cardStyle Mandatory RTExcelObj.MsoContactCardStyle parameter.
  ...
  @VTID(10)
  void show(
    RTExcelObj.MsoContactCardStyle cardStyle,
    int rectangleLeft,
    int rectangleRight,
    int rectangleTop,
    int rectangleBottom,
