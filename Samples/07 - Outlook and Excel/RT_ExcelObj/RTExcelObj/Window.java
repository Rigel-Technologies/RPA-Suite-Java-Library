...
public interface Window extends Com4jObject {
  ...
  @VTID(8)
  RTExcelObj._Windows collection();
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.vbext_WindowState
   */

  @DISPID(109) //= 0x6d. The runtime will prefer the VTID if present
  @VTID(21)
  RTExcelObj.vbext_WindowState windowState();
   ...
   * </p>
   * @param plWindowState Mandatory RTExcelObj.vbext_WindowState parameter.
   */

  @DISPID(109) //= 0x6d. The runtime will prefer the VTID if present
  @VTID(22)
  void windowState(
    RTExcelObj.vbext_WindowState plWindowState);
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.vbext_WindowType
   */

  @DISPID(112) //= 0x70. The runtime will prefer the VTID if present
  @VTID(24)
  RTExcelObj.vbext_WindowType type();


  /**
   * @param eKind Mandatory RTExcelObj.vbext_WindowType parameter.
   */

  @DISPID(113) //= 0x71. The runtime will prefer the VTID if present
  @VTID(25)
  void setKind(
    RTExcelObj.vbext_WindowType eKind);
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj._LinkedWindows
   */

  @DISPID(116) //= 0x74. The runtime will prefer the VTID if present
  @VTID(26)
  RTExcelObj._LinkedWindows linkedWindows();
  ...
  @VTID(27)
  RTExcelObj.Window linkedWindowFrame();
