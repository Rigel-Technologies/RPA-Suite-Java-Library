...
public interface SoftEdgeFormat extends RTExcelObj._IMsoDispObj {
  // Methods:
  /**
   * <p>
  ...
  @VTID(9)
  RTExcelObj.MsoSoftEdgeType type();
   ...
   * </p>
   * @param type Mandatory RTExcelObj.MsoSoftEdgeType parameter.
   */
