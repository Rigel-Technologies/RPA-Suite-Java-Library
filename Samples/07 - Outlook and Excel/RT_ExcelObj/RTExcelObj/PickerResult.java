...
public interface PickerResult extends RTExcelObj._IMsoDispObj {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.PickerFields
   */

  @DISPID(8) //= 0x8. The runtime will prefer the VTID if present
  @VTID(21)
  RTExcelObj.PickerFields fields();


  @VTID(21)
  @ReturnValue(defaultPropertyThrough={RTExcelObj.PickerFields.class})
  RTExcelObj.PickerField fields(
    int index);
   ...
   * </p>
   * @param fields Mandatory RTExcelObj.PickerFields parameter.
   */
