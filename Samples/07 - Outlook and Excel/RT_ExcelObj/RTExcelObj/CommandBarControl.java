...
public interface CommandBarControl extends RTExcelObj._IMsoOleAccDispObj {
  // Methods:
  /**
   * <p>
  ...
  @VTID(36)
  RTExcelObj.CommandBarControl copy(
  ...
  @VTID(52)
  RTExcelObj.CommandBarControl move(
    @Optional @MarshalAs(NativeType.VARIANT) java.lang.Object bar,
    @Optional @MarshalAs(NativeType.VARIANT) java.lang.Object before);
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.MsoControlOLEUsage
   */

  @DISPID(1610874904) //= 0x60040018. The runtime will prefer the VTID if present
  @VTID(54)
  RTExcelObj.MsoControlOLEUsage oleUsage();
   ...
   * </p>
   * @param pcou Mandatory RTExcelObj.MsoControlOLEUsage parameter.
   */

  @DISPID(1610874904) //= 0x60040018. The runtime will prefer the VTID if present
  @VTID(55)
  void oleUsage(
    RTExcelObj.MsoControlOLEUsage pcou);
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.MsoControlType
   */

  @DISPID(1610874920) //= 0x60040028. The runtime will prefer the VTID if present
  @VTID(70)
  RTExcelObj.MsoControlType type();
