...
public interface DocumentProperty extends Com4jObject {
   ...
   * </p>
   * @param lcid Mandatory int parameter.
   * @return  Returns a value of type RTExcelObj.MsoDocProperties
   */

  @VTID(13)
  RTExcelObj.MsoDocProperties type(
    @LCID int lcid);
   ...
   * </p>
   * @param lcid Mandatory int parameter.
   * @param ptypeRetVal Mandatory RTExcelObj.MsoDocProperties parameter.
   */

  @VTID(14)
  void type(
    @LCID int lcid,
    RTExcelObj.MsoDocProperties ptypeRetVal);
