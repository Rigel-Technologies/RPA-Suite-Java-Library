...
public interface SignatureSet extends RTExcelObj._IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @return  Returns a value of type RTExcelObj.MsoSignatureSubset
   */

  @DISPID(1610809353) //= 0x60030009. The runtime will prefer the VTID if present
  @VTID(18)
  RTExcelObj.MsoSignatureSubset subset();
   ...
   * </p>
   * @param psubset Mandatory RTExcelObj.MsoSignatureSubset parameter.
   */

  @DISPID(1610809353) //= 0x60030009. The runtime will prefer the VTID if present
  @VTID(19)
  void subset(
    RTExcelObj.MsoSignatureSubset psubset);
